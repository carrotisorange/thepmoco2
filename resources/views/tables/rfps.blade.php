    ...
    <x-table-body-component>
        ...
        <tr>
            ...
            <x-td>
                ...
                $accountpayable->status == "rejected by manager"))
                ...
                @elseif(($accountpayable->approver2_id == auth()->user()->id || Session::get('role_id') == 4) &&
                ($accountpayable->status=='approved by manager'))
                ...
                @elseif(($accountpayable->approver2_id == auth()->user()->id || Session::get('role_id') == 4) &&
                ($accountpayable->status=='approved by ap'))
                ...
                @elseif($accountpayable->approver2_id == auth()->user()->id && ($accountpayable->status=='liquidation approved
                by manager'))
