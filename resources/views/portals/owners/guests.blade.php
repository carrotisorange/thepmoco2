        ...
        <div class="mt-10 px-4 sm:px-6 lg:px-8">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-3xl font-bold text-gray-700">{{ $unit->unit }}/ Guests</h1>
                </div>
                <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                    {{-- <button type="button"
                        ...
                        Contract</button>
                    <button type="button"
                        class="inline-flex items-center justify-center rounded-md border border-transparent bg-gray-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">View
                        as thumbnail</button> --}}
            ...
            <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                ...
                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                    ...
                    <div
                        ...
                        @include('portals.owners.tables.guests')
