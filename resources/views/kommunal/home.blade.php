...
body {
  ...
  <header class="sm:relative lg:sticky top-0 z-10  h-16 flex-shrink-0">
      ...
      <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
        ...
        <nav class="hidden space-x-10 md:flex">
          <div class="relative">
            ...
            <button type="button" class="text-gray-900 group inline-flex items-center rounded-md text-base font-medium hover:text-gray-500 " aria-expanded="false">
              <span>Home</span>
              <!--
          ...
          <a href="#" class="text-base font-medium text-gray-900 hover:text-gray-500">About</a>
          <a href="#" class="text-base font-medium text-gray-900 hover:text-gray-500">FAQ</a>
          <a href="#" class="text-base font-medium text-gray-900 hover:text-gray-500">Support</a>
          <a href="#" class="text-base font-medium text-gray-900 hover:text-gray-500">Blog</a>

        </nav>
        <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
        <a href="#" class="inline-flex items-center justify-center whitespace-nowrap rounded-full border border-transparent bg-origin-border bg-indigo-300 px-4 py-1 text-base font-medium text-white shadow-sm hover:from-purple-700 hover:to-indigo-700">Sign up</a>
          <a href="newsignin" class="ml-8 whitespace-nowrap text-base font-medium text-gray-300 hover:text-gray-900">Sign in</a>
  ...
  <div class="flex-col justify-center px-4 sm:px-6  xl:px-48">
    <div class="w-full max-w-sm lg:w-96">
      
    <div class="text-gray-900 text-4xl font-bold py-24 sm:text-5xl lg:text-6xl">
      <span class="typing text-indigo-300" ></span>
       
        <p class="mb-8 font-light text-sm">Property Well Managed</p>
       <h2>Property Catalog</h2>

       <p class="mt-16 font-light text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
</div>

<form action="#" method="POST">
            <div class="-mt-10 flex justify-end space-x-5">
              <button type="submit" class="w-48 flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-medium text-white bg-indigo-300 hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Free Trial</button>
              <button type="submit" class="w-48 flex justify-center py-3 px-4 border border-gray-400 rounded-full shadow-sm text-sm font-medium text-gray-900  hover:bg-indigo-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">View Demo</button>            
            </div>
  ...
  <div class="flex-col justify-center py-8 lg:px-16 sm-px-0 ">
  <div class="lg:block  py-20 sm:ml-0 lg:-ml-5 mx-5">
...
<div class="min-h-screen relative bg-gradient-to-r from-indigo-300 to-gray-400 py-5 " >
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" />
              ...
              <h3 class=" ml-5 flex text-xl font-medium text-gray-600">Tenant Portal</h3>
              
          </div>
          <div class="flex justify-center items-center">
<div class="max-w-xs">
<div class="text-xs mt-6">
              <p class=" mt-2">View bills and payment history</p>
              <p class=" mt-2">Upload proof of payments of rent</p>
              <p class=" mt-2">Request for contract renewal or moveout</p>
              <p class=" mt-2">Send concerns or issues to management</p>
            </div>
  </div>
  </div>
          </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" />
              ...
              <h3 class="ml-5 flex text-xl font-medium text-gray-600">Billing and Collection</h3>
            </div>
