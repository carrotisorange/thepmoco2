  ...
  <div class="mx-auto max-w-2xl px-4 py-10 sm:px-6 lg:max-w-7xl lg:px-8">
    ...
    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            ...
            <img src="{{ asset('/brands/catalogue/sample-logo.png') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
        <!-- Item 2 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('/brands/catalogue/sample-logo.png') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
...
<span class="font-light text-sm">Parking</span>
      ...
      <div class="py-8 px-8 border border-gray-400 rounded-md h-96">
        ...
        <div class="px-20 grid grid-cols-2">
