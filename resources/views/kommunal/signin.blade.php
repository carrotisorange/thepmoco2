...
body {
  ...
  <div class="">
  <div class="flex items-center justify-center py-2 px-4 sm:px-6 lg:px-20 xl:px-24">
    <div class="mx-auto max-w-xl py-20 ">
      
      <div>
        
        <h2 class="mb-10 text-center mt-2 text-2xl tracking-tight font-semibold text-gray-700">Sign in </h2>
