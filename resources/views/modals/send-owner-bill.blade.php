<div id="send-owner-bill" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex justify-end p-2">
                <button type="button"
                    ...
                    data-modal-toggle="send-owner-bill">
            ...
            <form class="px-12 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8"
                action="/property/{{ Session::get('property_uuid') }}/owner/{{ $owner->uuid }}/bill/send">
                @csrf
                ...
                <div class="mt-5 flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-full px-3">
                        ...
                        {{ number_format(App\Models\Bill::postedBills('owner_uuid',$owner->uuid) - App\Models\Collection::postedCollections('owner_uuid',$owner->uuid),2) }}
