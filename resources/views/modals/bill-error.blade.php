<div id="popup-error-modal" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                ...
                data-modal-toggle="popup-error-modal">
            ...
            <div class="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Can't proceed with the moveout due
                    to unpaid bills.</h3>

                <button data-modal-toggle="popup-error-modal" type="button"
