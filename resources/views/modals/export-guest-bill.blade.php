<div id="export-guest-bill" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex justify-end p-2">
                <button type="button"
                    ...
                    data-modal-toggle="export-tenant-bill">
            ...
            <form class="px-12 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8"
                action="/property/{{ Session::get('property') }}/guest/{{ $guest->uuid }}/bill/export">
                @csrf
                ...
                <div class="mt-5 flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-full px-3">
                        ...
                        {{ number_format($unpaid_bills->sum('bill')-$unpaid_bills->sum('initial_payment'), 2) }} ({{
                        $unpaid_bills->count() }} bills)
