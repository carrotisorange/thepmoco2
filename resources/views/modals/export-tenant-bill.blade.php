<div id="export-tenant-bill" tabindex="-1" aria-hidden="true"
            ...
            <form class="px-12 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="/property/{{ Session::get('property') }}/tenant/{{ $tenant->uuid }}/bill/export">
                ...
                <div class="mt-5 flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-full px-3">
                        ...
                        {{ number_format(App\Models\Bill::where('tenant_uuid', $tenant->uuid)->sum('bill') -  App\Models\Collection::where('tenant_uuid', $tenant->uuid)->sum('collection'),2) }}
