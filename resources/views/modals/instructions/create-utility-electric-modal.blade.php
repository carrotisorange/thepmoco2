            ...
            <div
                ...
                <div>
                    ...
                    <div class="mt-3 text-center sm:mt-5">
                        <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Record electric readings
                        </h3>
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">You're about to record electric readings for {{ $totalUnitsCount }} unit/s. This may take a while.</p>
                        </div>
                    </div>
                </div>
