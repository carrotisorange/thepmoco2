<div id="create-reference-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex justify-end p-2">
                <button type="button"
                    ...
                    data-modal-toggle="create-reference-modal">
            ...
            <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" method="POST"
                action="/tenant/{{ $tenant_details->uuid }}/reference/store">
                @csrf
                <h3 class="text-xl font-medium text-gray-900 dark:text-white">Enter Reference Information</h3>
                <div>
