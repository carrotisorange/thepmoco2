<div id="send-tenant-bill" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex justify-end p-2">
                <button type="button"
                    ...
                    data-modal-toggle="send-tenant-bill">
            ...
            <form class="px-12 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="/property/{{ Session::get('property') }}/tenant/{{ $tenant->uuid }}/bill/send">
                @csrf
