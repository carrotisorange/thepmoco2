            ...
            -->
                        ...
                        <div class="absolute right-0 z-30 mt-2 w-40 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                            ...
                            <div class="py-1" role="none">
                                ...
                                <a href="/user/{{ Auth::user()->username }}/subscriptions" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                                    id="menu-0-item-0"> Subscription </a>
                                <a href="/property" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                                    id="menu-0-item-0"> Properties </a>
                                    <a href="/users" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-0-item-0">
                                        Users </a>
                ...
                <footer class="">
                    <div
                        ...
                        <div class="flex justify-center space-x-6 md:order-2">
                            <a href="https://www.facebook.com/onlinepropertymanager/" class="text-gray-400 hover:text-gray-500">
                            ...
                            <a href="https://www.thepropertymanager.online/support/" class="text-gray-400 hover:text-gray-500">
