<x-new-layout>
    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mt-5 px-4 sm:px-6 lg:px-8 overflow-auto">
            ...
            <table class=" w-full mb-10 text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <x-td>Value</x-td>
                        <x-td>Approved</x-td>
                        <x-th><button class="border bg-purple-500 text-sm text-white rounded-lg px-2 py-1">View</button>
                        </x-th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <x-td>Value</x-td>
                        <x-td>Pending</x-td>
                        <x-th><button class="border bg-purple-500 text-sm text-white rounded-lg px-2 py-1">Edit</button>
                        </x-th>
                    </tr>
