                        ...
                        <div class="grid grid-cols-1 gap-x-4  sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="bg-purple-100 h-20 overflow-hidden shadow rounded-lg mb-5 mt-2">
                                    ...
                                    <div class="text-center font-semibold font-body text-gray-500 truncate"><a
                                            href="/property/{{ $property->uuid }}/unit" class="text-gray-700 text-3xl ">{{
                                            $units->count() }}</a> </div>
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-3">
                                <div class="bg-purple-100 h-20 overflow-hidden shadow rounded-lg mb-5 mt-2">
                                    ...
                                    <div class="text-center font-semibold font-body text-gray-500 truncate"><a
                                            href="/property/{{ $property->uuid }}/tenant" class="text-gray-700 text-3xl ">{{
                                            $tenants->count() }}</a> </div>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="bg-purple-100 h-16 overflow-hidden shadow rounded-lg mb-2">
                                    <div class="py-3 text-center font-semibold font-body text-gray-500 truncate"><a href=#
                                            class="text-gray-700 text-3xl ">{{ $movingout_contracts->count()
                                            }}</a> </div>
                                </div>
                            </div>
                            <div class="sm:col-span-3">
                                ...
                                <div class="bg-purple-100 h-16 overflow-hidden shadow rounded-lg mb-2">
                                    <div class="py-3 text-center font-semibold font-body text-gray-500 truncate"><a href=#
                                            class="text-gray-700 text-3xl ">{{ $movingin_contracts->count()
                                            }}</a> </div>
                                </div>
                            </div>
                                        ...
                                        <div class="sm:col-span-6">
                                            <dl>
                                                ...
                                                <dd>
                                                    ...
                                                    <h2 class="text-lg leading-3 ml-0 font-medium text-gray-600 mt-5 mb-2">
                                                        Notifications</h2>
                                                </dd>
                                            </dl>
                                        </div>
