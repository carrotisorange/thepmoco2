                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="w-0 flex-1">
                                        <div class="text-l font-semibold font-body text-gray-500 truncate">
                                            ...
                                            <a href="/property/{{ Session::get('property') }}/contract/{{ $status }}"
                                                class="font-medium text-blue-900">{{
                                                $pending_moveout_contracts->count() }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-4 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            <div class="mt-2 text-sm text-center font-semibold font-body text-gray-500 truncate">
                                Vacant:
                                <a a href="/property/{{ $property->uuid }}/unit/" class="text-indigo-600 text-lg">{{
                                    $vacant_units }}</a>
                            </div>
