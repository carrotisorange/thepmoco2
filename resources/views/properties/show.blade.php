        ...
        <div class="mt-5 px-4 sm:px-5 lg:px-1">
                    ...
                    <div class="lg:ml-6 md:ml-5 sm:ml-1 max-w-md sm:px-6 sm:mx-3 lg:mx-5 lg:px-5">
                        <div class="relative shadow-md sm:overflow-hidden sm:rounded-2xl">
                            ...
                            <div class="relative px-4 py-10 sm:px-6 sm:py-20 lg:py-10 lg:px-8">
                               ...
                               <a href="/property/{{ $property->uuid }}/notification"><p class="mt-8 text-gray-600">You have <span class="font-semibold">2</span>
                                new notifications!</p></a>
                                ...
                                <div class=" rounded-lg dark:bg-gray-800 hidden" id="profile" role="tabpanel"
                                                ...
                                                <div class="flex items-center ">
                                                    <div class="">
                                                        <div class="ml-2 flex items-center">
                                                            ...
                                                            <span class="animate-pulse mx-1 text-red-600">{{ $payment_requests->count() }}</span>
                                    ...
                                    <li class="border-gray-400 flex flex-row mb-2">
                                        <div
                                            ...
                                            <div class="flex-1 pl-1 mr-16">
                                                ...
                                                <div class="text-gray-600 text-sm">{{ number_format($item->amount, 2) }}</div>
                                            </div>
                                            <div button type="button"
                                                ...
                                                <a href="/property/{{ $property->uuid }}/tenant/{{ $item->tenant_uuid }}/payment_requests/{{ $item->id }}">View</a></button>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <div class="flex justify-end gap-2">
                                        <div
                                            ...
                                            <a href="/property/{{ $property->uuid }}/collection/pending">See more payment requests</a></button>
                                        </div>
                                ...
                                <div class="rounded-lg dark:bg-gray-800" id="dashboard" role="tabpanel"
                                        ...
                                        <div class="col-span-1">
                                            <div class="h-5 w-full overflow-hidden">
                                                <div class="flex items-center ">
                                                    <div class="">
                                                        <div class="ml-2 flex items-center">
                                                            <span class="animate-pulse mx-1 text-red-600">{{ $pending_concerns->count() }}</span>
                                                            <div class="text-sm font-regular text-gray-600">
                                    ...
                                    <li class="border-gray-400 flex flex-row mb-2">
                                        <div
                                            ...
                                            <div button type="button"
                                                class="items-center text-center px-2.5 py-1.5 border w-20 mt-5 border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                                <a href="/property/{{ $property->uuid }}/concern/{{ $item->id }}">Respond</a></button>
                                            </div>
                                    ...
                                    <div class="flex justify-end gap-2">
                                        <div
                                            class="items-center text-center px-2.5 py-1 mt-3  text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-900">
                                            <a href="/property/{{ $property->uuid }}/concern">See more concerns</a></button>
                                        </div>
                                ...
                                <div class="rounded-lg dark:bg-gray-800 hidden" id="settings" role="tabpanel"
                                        ...
                                        <div class="col-span-1">
                                            <div class="h-5 w-full overflow-hidden">
                                                <div class="flex items-center ">
                                                    <div class="">
                                                        <div class="ml-2 flex items-center">
                                                            <span class="animate-pulse mx-1 text-red-600">{{ $pending_contracts->count() }}</span>
                                                            <div class="text-sm font-regular text-gray-600">
                                    ...
                                    <li class="border-gray-400 flex flex-row mb-2">
                                        <div
                                            ...
                                            <div button type="button"
                                                class="items-center text-center px-2.5 py-1.5 border w-20 mt-5 border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                                <a href="/property/{{ $property->uuid }}/tenant/{{ $item->tenant_uuid }}/contract/{{ $item->uuid }}/moveout">View</a></button>
                                            </div>
                                        </div>
                                    </li>
                                    <span class="text-sm">{{ Carbon\Carbon::parse($item->created_at)->diffForHumans() }}</span>
                                    ...
                                    <div class="flex justify-end gap-2">
                                        <div
                                            class="items-center text-center px-2.5 py-1 mt-3  text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-900">
                                            <a href="/property/{{ $property->uuid }}/contract/pending">See more moveout requests</a></button>
                                        </div>
                            ...
                            <div class="flex items-center px-5 py-3">
                                ...
                                <div class="mr-5">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="text-3xl font-bold text-white mr-2">{{ App\Http\Controllers\CollectionController::shortNumber($current_monthly_collections) }}</div>
                                       <?php $change_in_monthly_collections = App\Http\Controllers\CollectionController::divNumber($current_monthly_collections, $previous_monthly_collections)*100;?>
                                        @if($previous_monthly_collections > $current_monthly_collections)
                                        <div class="text-md font-medium text-red-500">-{{ number_format($change_in_monthly_collections, 1) }}%</div>
                                        @else
                                        <div class="text-md font-medium text-green-500">{{ number_format($change_in_monthly_collections, 1) }}%</div>
                                        @endif
                                ...
                                <div class="mr-5">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="text-3xl font-bold text-white mr-2">{{
                                            App\Http\Controllers\CollectionController::shortNumber($current_monthly_expenses) }}</div>
                                        ...
                                        @if($previous_monthly_expenses > $current_monthly_expenses)
                                        <div class="text-md font-medium text-red-500">-{{ number_format($change_in_monthly_expenses, 1) }}%</div>
                                        @else
                                        <div class="text-md font-medium text-green-500">{{ number_format($change_in_monthly_expenses, 1) }}%</div>
                                        @endif
                        ...
                        <div
                            ...
                            <div class="flex items-center px-5 py-7">
                                <div class="mr-5">
                                    ...
                                    <div class="flex items-center">
                                        <div class="text-3xl font-semibold text-gray-400 mr-2">{{ number_format($current_occupancy_rate->occupancy_rate, 1) }}%</div>
                        ...
                        <div
                            ...
                            <div class="flex items-center px-5 py-7">
                                <div class="mr-5">
                                    ...
                                    <div class="flex items-center">
                                        <div class="text-3xl font-semibold text-gray-400 mr-2">{{ $current_monthly_moveins }}</div>
           ...
           <?php $period = Carbon\CarbonPeriod::create(now(), now()->addDays(6)) ;?>
            ...
            <div
                ...
                <div class='flex items-center px-4 py-4'>
                    <div class='text-center'>
                        <p class='text-gray-900 group-hover:text-purple-900 text-sm transition-all	duration-300'>
                            {{ $date->format('D') }} 
                        </p>
                        <p class='text-gray-900 group-hover:text-purple-900 mt-3 group-hover:font-bold transition-all	duration-300'>
                            {{ $date->format('d') }} </p>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="flex items-center ">
                                            <div class="ml-20 mt-2">
                                                <div class="flex items-center">
                                                    ...
                                                    <span class="font-semibold text-gray-800 text-lg mx-1">{{ $units->count() }}</span>
                                        ...
                                        <div class="flex items-center ">
                                            <div class="mt-2">
                                                <div class="flex items-center">
                                                    ...
                                                    <span class="font-semibold text-gray-800 text-lg mx-1">{{ $tenants->count() }}</span>
            ...
            <div class="px-10 mt-10 gap-y-5 gap-x-6 sm:mt-10 sm:grid grid-cols-1 lg:grid-cols-6 lg:gap-x-5">
                ...
                <div class="bg-white mt-10 mr-5 pt-12 px-5 rounded-lg shadow-lg lg:my-10 sm:my-20 pb-4 col-span-4">
                    <div class="px-4 py-3 flex justify-end  sm:px-6">
                        ...
                        <nav class="mt-2 relative z-0 inline-flex rounded-lg shadow-sm space-x-3"
                            aria-label="Pagination">

                            <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                            <a href="#"
                                class="bg-white border-gray-300 text-gray-500 hover:bg-gray-50 relative inline-flex items-center px-4 py-2 border text-sm font-medium rounded-lg">
                                Week </a>
                            <a href="#"
                                class="bg-white border-gray-300 text-gray-500 hover:bg-gray-50 hidden md:inline-flex relative items-center px-4 py-2 border text-sm font-medium rounded-lg">
                                Month </a>
                            <a href="#" aria-current="page"
                                class="z-10 bg-pink-50 border-pink-500 text-pink-600 relative inline-flex items-center px-4 py-2 border text-sm font-medium rounded-lg">
                                This Year </a>
