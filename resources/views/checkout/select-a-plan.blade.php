        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div class="bg-white py-5 px-4 shadow sm:rounded-lg sm:px-10">
                ...
                <form class="space-y-2" action="/register" method="POST">
                    ...
                    <p class="mt-2 text-sm text-gray-500">By clicking Sign Up, you agree to our <a href="/#" target="_blank"><span class="font-medium text-indigo-600">Terms of Service</span></a> and <a href="/#" target="_blank"><span class="font-medium text-indigo-600">Privacy Policy</span></a>.</p>
