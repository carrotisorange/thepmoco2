...
<p>
    Welcome to {{ env('APP_NAME') }}. You have come to the right place to digitalize
...
<p>
    As a database storage, your data is encrypted and information is made secure with COMODO SSL, a global security
    authority, giving you
    that peace of mind. Start migrating your HOA data in {{ env('APP_NAME') }}. Should you need help in migrating your
    data faster, our
