...
<table class="">
    ...
    <tr>
        ...
        <x-td>{{ Carbon\Carbon::parse($item->start)->format('M d, Y').'-'.Carbon\Carbon::parse($item->end)->format('M d,
            Y') }} </x-td>
        <?php 
        ...
        <x-td>
            ...
            {{ number_format((($item->bill + $other_fees) -App\Models\Collection::where('bill_id',
