                    ...
                    <ol role="list"
                            ...
                            <div class="border border-gray-200 overflow-hidden lg:border-0">
                                ...
                                <a href="#" aria-current="step">
                                    ...
                                    <span class="px-6 py-5 flex items-start text-sm font-medium lg:pl-9">
                                        ...
                                        <span class="mt-0.5 ml-4 min-w-0 flex flex-col">
                                            <span class="text-sm font-medium text-indigo-600">Guardian Information
                                            </span>
                            ...
                            <div class="border border-gray-200 overflow-hidden lg:border-0">
                                ...
                                <a href="#" aria-current="step">
                                    ...
                                    <span class="px-6 py-5 flex items-start text-sm font-medium lg:pl-9">
                                        ...
                                        <span class="mt-0.5 ml-4 min-w-0 flex flex-col">
                                            <span
                                                class="text-sm font-medium text-gray-500 group-hover:text-gray-900">Reference Information</span>
                            ...
                            <div class="border border-gray-200 overflow-hidden lg:border-0">
                                ...
                                <a href="#" aria-current="step">
                                    ...
                                    <span class="px-6 py-5 flex items-start text-sm font-medium lg:pl-9">
                                        ...
                                        <span class="mt-0.5 ml-4 min-w-0 flex flex-col">
                                            <span
                                                class="text-sm font-medium text-gray-500 group-hover:text-gray-900">Contract Information</span>
                        ...
                        <li class="relative overflow-hidden lg:flex-1">
                            <div class="border border-gray-200 overflow-hidden lg:border-0">
                                <!-- Current Step -->
                                <a href="#" aria-current="step">
                                    <span class="absolute top-0 left-0 w-1 h-full  lg:w-full lg:h-1 lg:bottom-0 lg:top-auto"
                                        aria-hidden="true"></span>
                                    <span class="px-6 py-5 flex items-start text-sm font-medium lg:pl-9">
                                        <span class="flex-shrink-0">
                                            <span
                                        ...
                                        <span class="mt-0.5 ml-4 min-w-0 flex flex-col">
                                            <span class="text-sm font-medium text-gray-500 group-hover:text-gray-900">Deposit
                                                Information</span>
                                        </span>
                                    </span>
                                </a>
