...
<head>
    ...
    <title>Subscriptions | The Property Manager</title>
</head>
                    ...
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <x-nav-link href="#/" :active="request()->routeIs('subscription')">
                                <i class="fa-solid fa-file-invoice"></i>&nbspSubscriptions
                            </x-nav-link>
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    {{-- <form method="POST" action="/user/{{ auth()->user()->username }}/subscriptions/{{ $subscription->external_id }}/unsubscribe">
                                                        @csrf
                                                        <button type="submit"
