  ...
  <header class="flex items-center justify-between border-b border-gray-200 py-4 px-6">
    ...
    <div class="flex items-center">
      ...
      <div class="hidden md:ml-4 md:flex md:items-center">
        ...
        <button type="button" class="ml-6 rounded-md border border-transparent bg-gray-900 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2">Book</button>
      </div>
