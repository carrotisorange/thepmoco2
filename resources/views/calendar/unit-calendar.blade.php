...
<div class="bg-gray-200 sm:p-0 lg:px-20">
	...
	<div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
		<div class="container mx-auto px-4 py-2 md:py-10">
            ...
            <div class="grid grid-cols-3">
                ...
                <div class="col-span-1">
			        <div class="font-bold text-center text-gray-800 text-xl mb-4">
				    Unit #</div>
                </div>

                <div class="col-span-1 flex justify-end">
			        <a href="#calendar-list"><button class="p-2 rounded-lg bg-gray-700 font-light text-center text-white text-sm mb-4">
				    view list</button></a>
                </div>
            </div>
    ...
    <div id="calendar-list" class="bg-white rounded-lg shadow-lg p-3 mt-12">
        ...
        <ol class="mt-2 divide-y divide-gray-200 text-sm leading-6 text-gray-500">
            <li class="py-4 sm:flex">
                ...
                <p class="ml-5 mt-2 flex-auto sm:mt-0">Nothing on today’s schedule</p>
            </li>
            <li class="py-4 sm:flex">
                <time datetime="2022-01-19" class="w-28 flex-none">Thu, Jan 13</time>
                <p class="ml-5 mt-2 flex-auto font-semibold text-gray-900 sm:mt-0">View house with real estate agent</p>
            ...
            <li class="py-4 sm:flex">
                ...
                <p class="ml-5 mt-2 flex-auto font-semibold text-gray-900 sm:mt-0">Meeting with bank manager</p>
                <p class="flex-none sm:ml-6">All day</p>
            </li>
            <li class="py-4 sm:flex">
                <time datetime="2022-01-18" class="w-28 flex-none">Mon, Jan 17</time>
                <p class="ml-5 mt-2 flex-auto font-semibold text-gray-900 sm:mt-0">Sign paperwork at lawyers</p>
