                    ...
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                        <nav class="rounded-md">
                            <ol class="list-reset flex">
                                ...
                                <li><span class="text-gray-500 mx-2">/</span></li>
                                <li class="text-gray-500">Units</li>
                            </ol>
                        </nav>
                    </h2>
                </div>
                <h5 class="flex-1 text-right">
                   <x-button onclick="window.location.href='/property/{{ Session::get('property') }}/owners'"><i class="fa-solid fa-circle-arrow-left"></i>&nbsp
                        Back
                    </x-button>
                </h5>
            </div>
