                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <x-td>1200</x-td>
                                        <x-td>
                                        <button type="button" data-modal-toggle="default-modal" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">

                                                <img src="{{ asset('/brands/receipt-sample.jpg') }}" alt="election vector" class="w-36"/>
                                                </button>
