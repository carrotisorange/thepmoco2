...
<body>
    ...
    <header>
        <div class="mx-auto max-w-4xl px-6">
            ...
            <h1 class="py-8 text-center text-lg font-bold text-gray-800 tracking-wide">Daily Collection Report</h1>
        </div>
    ...
    <main class="mx-auto max-w-4xl px-6">
        ...
        <div class="flex justify-between text-base pt-6">
            ...
            <div>
                <p>Collections: <span class="ml-2 font-semibold tracking-wider">1234345</span></p>
            </div>
        </div>
                    ...
                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        <table class="min-w-full divide-y divide-gray-300">
                            <thead>
                                ...
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">AR #</th>
                                ...
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Bill to</th>
                            ...
                            <tbody class="bg-white">
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">Juan Cruz</td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">rent</td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">October 23-November 23</td>
