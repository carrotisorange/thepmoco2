        ...
        <div class="mx-auto py-32 sm:py-48 lg:py-48">
          <div class="text-center">
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6">
              <a href="#services" class="rounded-2xl bg-gray-200 px-3.5 py-2.5 text-lg text-gray-600 font-medium shadow-sm hover:bg-gray-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Get started</a>
            </div>
          </div>
        </div>
                ...
                <div class="flex flex-col overflow-hidden rounded-xl">
                  <div class="flex flex-1 flex-col justify-center items-center bg-gray-700 w-full p-6">
                    <div class="flex-1">                     
                      ...
                      <a href="/proppay"> <img src="{{ asset('/brands/propsuite/proppay-notext.png') }}"></a>
            ...
            <div class="py-20 mx-auto px-4  sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
              <blockquote>
                <div>
                  ...
                  <p class="mt-6 text-base font-light text-gray-700 tracking-wide">is a system as a service
