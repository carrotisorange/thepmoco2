<x-landing-page-template>
    ...
    <body id="background">
        ...
        <div class="-mt-32 pb-56 flex items-center justify-center gap-x-6">
            <a href="#services"
                class="rounded-full bg-yellow-300 px-3.5 py-2 text-base text-gray-600 font-medium shadow-sm hover:bg-yellow-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Get
                Started</a>
        </div>
        ...
        <div id="services" class="bg-white py-16 sm:py-24 lg:py-32" id="guide">
            <div class="">
                ...
                <div
                    class="mx-auto mt-12 grid max-w-md gap-8 px-4 sm:max-w-lg sm:px-6 lg:max-w-5xl lg:grid-cols-3 lg:px-8">
                    ...
                    <div class="flex flex-col overflow-hidden rounded-xl">
                        ...
                        <p class="py-3 text-sm font-light text-gray-500">I need a property management system to manage
                            my property.
                        </p>
                    </div>
                    ...
                    <div class="flex flex-col overflow-hidden rounded-xl">
                        ...
                        <p class="py-3 text-sm font-light text-gray-500">I need to advertise my listings/I want to look
                            for
                    ...
                    <div class="flex flex-col overflow-hidden rounded-xl">
                        ...
                        <p class="py-3 text-sm font-light text-gray-500">I need a property management service to help in
                            managing my
                            properties.</p>
                    </div>
        ...
        <div id="propman" class="propman-bg sm:block lg:flex md:flex  py-16">
            ...
            <div class="flex-col justify-center sm:-py-2 md:py-20 lg:py-8 lg:px-48 sm-px-0">
                <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-md sm:ml-12 sm:py-2  mx-5">
                    <p class="text-lg font-light mt-10 text-white">Property Management System for long term and short
                        term rental
                        properties and home owners associations. </p>

                    <div class="mt-10 flex justify-center items-center space-x-5">
                        <button class="bg-yellow-200 rounded-full"> <a href="propman"
        ...
        <div id="proprent-bg" class="sm:block lg:flex md:flex py-16">
            ...
            <div class="flex-col justify-center sm:-py-2 md:py-20 lg:py-8 lg:px-48 sm-px-0">
                <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-md sm:ml-12 sm:py-2 mx-5">
                    <p class="text-lg font-light mt-10 text-white">Leasing platform for rental property owners to list
                        vacant
                        rooms and units for long term or short term rentals. </p>

                    <div class="mt-10 flex justify-center items-center space-x-5">
                        <button class="proprentOrangebg rounded-full"> <a href="/select-a-plan"
                                class="w-48 flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-medium text-white  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Free
                                Trial</a></button>
                        <button> <a href="demopage"
                                class="w-48 flex justify-center py-3 px-4 border border-gray-400 rounded-full shadow-sm text-sm font-medium text-white hover:bg-purple-300  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">View
        ...
        <div id="propbiz-bg" class="sm:block lg:flex md:flex py-16">
            ...
            <div class="flex-col justify-center sm:-py-2 md:py-20 lg:py-8 lg:px-48 sm-px-0">
                <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-lg sm:ml-12 sm:py-2 lg:-ml-5 mx-5">
                    <p class="text-lg font-light mt-10 text-white">Property management services that provides online and
                        onsite
                        operations management services to rental property owners.</p>

                    <div class="mt-10 flex justify-center items-center space-x-5">
                        <button class="propbizOrangebg rounded-full"> <a href="/select-a-plan"
                                class="w-48 flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-medium text-white  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Free
                                Trial</a></button>
                        <button> <a href="demopage"
                                class="w-48 flex justify-center py-3 px-4 border border-gray-400 rounded-full shadow-sm text-sm font-medium text-white hover:bg-purple-300  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">View
