    ...
    <form method="POST" wire:submit.prevent="submitForm" id="create-form">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-1/2 px-3">
                ...
                <x-form-input wire:model="account_name"
                    id="account_name" type="text" name="account_name" value="{{ old('account_name', $owner) }}" />
            ...
            <div class="w-full md:w-1/2 px-3">
                ...
                <x-form-input wire:model="bank_name"
            ...
            <div class="w-full md:w-full px-3 mt-5">
                ...
                <x-form-input wire:model="account_number"
