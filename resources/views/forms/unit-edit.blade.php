    ...
    <div class="lg:grid lg:grid-cols-12 lg:auto-rows-min lg:gap-x-8">
        ...
        <div class="mt-8 lg:col-span-8">
            <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center grid grid-cols-5 gap-2 sm:grid-cols-5"
                    ...
                    <li class="mr-2" role="presentation">
                        <button
                            class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700"
                            id="financials-tab" data-tabs-target="#financials" type="button" role="tab" aria-controls="financials"
            ...
            <div id="myTabContent">
                ...
                <div class="hidden rounded-lg dark:bg-gray-800" id="financials" role="tabpanel" aria-labelledby="financials-tab">
                    <div class="text-sm">
                                    ...
                                    <div class="p-4">
                                        <div class="flex items-start">
                                            <div class="flex-shrink-0">
                                                <svg class="w-6 h-6" viewBox="-3 0 143 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <defs>
                                                        <clipPath id="a">
                                                            <path fill="#fff" transform="translate(.735 .953)" d="M0 0h135.862v141.769H0z" />
                                                        </clipPath>
                                                    </defs>
                                                </svg>
                                            </div>
                                            <div class="ml-3 w-0 flex-1 pt-0.5">
                                                ...
                                                <p class="text-sm font-medium text-gray-900">Purchasing Price
                                                    </p>
                                ...
                                <div
                                    ...
                                    <div class="p-4">
                                        <div class="flex items-start">
                                            ...
                                            <div class="flex-shrink-0">
                                                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 95.929 95.929"
                                                    style="enable-background:new 0 0 95.929 95.929" xml:space="preserve">
                                                    <path
