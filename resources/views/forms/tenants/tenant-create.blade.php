    ...
    <div class="mt-5 px-4 py-5 sm:rounded-lg sm:p-6">
        <div class="md:grid md:grid-cols-1 md:gap-6">
            <div class="mt-5 md:mt-0 md:col-span-3">
                <div class="grid grid-cols-1 lg:grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 lg:col-span-1">
                        ...
                        <x-form-select wire:model="category" autocomplete="category">
                    ...
                    <div class="col-span-6 lg:col-span-1">
                        ...
                        <x-form-select wire:model="gender" autocomplete="gender">
                            ...
                            <option value="female" {{ old('gender')=='female' ? 'selected' : 'Select one' }}> {{
                                'female' }}</option>
                            <option value="male" {{ old('gender')=='male' ? 'selected' : 'Select one' }}>{{ 'male' }}
                            </option>
                            <option value="LGBTQ" {{ old('gender')=='LGBTQ' ? 'selected' : 'Select one' }}>{{'LGBTQ' }}
                            </option>
                        </x-form-select>
                    ...
                    <div class="col-span-6 lg:col-span-2">
                        ...
                        <x-form-select wire:model="country_id" autocomplete="country_id">
                            ...
                            <option value="{{ $country->id }}" {{ old('country_id')==$country->id?'selected': 'Select
                                one' }}>{{ $country->country }}</option>
                            @endforeach
                        </x-form-select>
                    ...
                    <div class="col-span-6 lg:col-span-2">
                        ...
                        <x-form-select wire:model="province_id" autocomplete="province_id">
                            ...
                            <option value="{{ $province->id }}" {{ old('province_id')==$province->id? 'selected':
                                'Select one' }}>{{ $province->province }}</option>
                            @endforeach
                        </x-form-select>
                    ...
                    <div class="col-span-6 lg:col-span-2">
                        ...
                        <x-form-input type="text" wire:model="barangay" autocomplete="barangay"
                            value="{{ old('barangay') }}" />
                    ...
                    <div class="col-span-6">
                        ...
                        <x-form-select wire:model="type" autocomplete="type">
                            <option value="">Select one</option>
                    ...
                    <div class="col-span-1">
                        ...
                        <x-form-input type="text" wire:model="course" autocomplete="course"
                            value="{{ old('course') }}" />
                    ...
                    <div class="col-span-1">
                        ...
                        <x-form-input type="text" wire:model="year_level" autocomplete="year_level"
                            value="{{ old('year_level') }}" />
                        <x-validation-error-component name='year_level' />
                    </div>
                    <div class="col-span-2">
                        <x-label for="school">School </x-label>
                        <x-form-input type="text" wire:model="school" autocomplete="school"
                            value="{{ old('school') }}" />
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" wire:model="school_address" autocomplete="school_address"
            ...
            <div class="flex justify-end mt-2">
                {{-- <x-button
                    onclick="window.location.href='{{ asset('/brands/docs/Contract of Lease TEMPLATE.docx') }}'">
