<div>
    <form class="space-y-3" method="POST" wire:submit.prevent="submitForm()">
        ...
        <div class="pt-10">
            ...
            <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                <div class="sm:col-span-6">
                    <label for="property" class="block text-sm font-medium text-gray-700"> What's your property name? </label>
                    <div class="mt-5">
            ...
            @if($property)
                <div class="sm:col-span-3">
                    <label for="country_id" class="block text-sm font-medium text-gray-700"> Which country property your is located? </label>
                    <div class="mt-5">
        ...
        <div class="flex justify-end mt-2">
           ...
           <a class="whitespace-nowrap px-3 py-2 text-sm text-black-500 text-decoration-line: underline"
                href="/property">
                Cancel
            </a>
            @if($type_id)
