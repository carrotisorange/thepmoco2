                    ...
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <img width="1920" height="1080" src="{{ asset('/brands/landing/portfolio_img.webp') }}"
                            ...
                            <div class="swiper-slide">
                                ...
                                <img width="1920" height="1080" src="{{ asset('/brands/landing/dashboard_img.webp') }}"
                            ...
                            <div class="swiper-slide">
                                ...
                                <img width="1920" height="1080" src="{{ asset('/brands/landing/employee_img.webp') }}"
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                                    ...
                                    <div class="relative">
                                        <img class="mx-auto w-10 h-10" src="{{ asset('/brands/clients/client-2.png') }}"
                            ...
                            <div class="swiper-slide">
                                <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                                    ...
                                    <div class="relative">
                                        <img class="mx-auto w-20 h-20" src="{{ asset('/brands/clients/client-3.png') }}"
                                            alt="Martha logo">
                                        <blockquote class="mt-10">
                                            <div
                                                class="mx-auto max-w-3xl text-center text-xl font-medium leading-9 text-gray-900">
