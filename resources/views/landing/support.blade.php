<x-new-layout-base>
  ...
  <div class="max-w-full mx-auto sm:px-6">
    ...
    <div class="py-20 mt-0 sm:mt-0 min-h-full  lg:gap-8 lg:px-8 bg-gray-600">
    ...
    <div class="mt-0  min-h-full lg:grid pb-10 lg:grid-cols-2 lg:gap-8 lg:px-8 bg-white">
      ...
      <div class="mt-24 lg:mt-0 sm:pl-20 px-5 sm:px-20 md:px-20 lg:px-20 lg:py-10 lg:col-start-2">
        <div class="flex justify-center items-center">
    ...
    <div class="mb-16 mt-0 sm:mt-0 min-h-full lg:grid  lg:grid-cols-2 lg:gap-8 lg:px-8 bg-purple-100">
