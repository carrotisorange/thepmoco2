        ...
        <header>
            ...
            -->
                    ...
                    <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                        <a href="/select-a-plan" class="inline-flex items-center justify-center whitespace-nowrap rounded-full border border-transparent bg-origin-border bg-purple-500 px-4 py-1 text-base font-medium text-white shadow-sm hover:from-purple-700 hover:to-indigo-700">Sign
                            up</a>
                        <a href="/login"
                            class="ml-8 whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">Sign
                            in</a>
            ...
            <div class="bg-gray-900">
                <div
                    ...
                    <h2 class="text-4xl font-bold tracking-tight text-gray-200 sm:text-4xl">
                        <span class="block">Need help with your rental property?</span>
                        <span
                            class="-mb-1 block bg-gradient-to-r from-purple-300 to-indigo-600 bg-clip-text pb-1 text-transparent">Contact
                            Us.</span>
                    </h2>
                ...
                <div class="">
                    <div class="relative bg-white shadow-xl">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3">
                            <!-- Contact information -->
                            <div class="px-5 relative overflow-hidden py-10 sm:px-10 xl:p-12"
                                style="background-image: url('/brands/contact.jpg ');">
                            ...
                            <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                                ...
                                <div>
                                    <h2 class="text-3xl font-semibold mb-5">{{ env('APP_NAME') }}</h2>
                                    <p class="text-gray-500">{{ env('APP_SECOND_ADDRESS') }}</p>
                                </div>
                                ...
                                <form action="#" method="POST"
                                    ...
                                    <div>
                                        <label for="first-name" class="block text-sm font-medium text-gray-900">First
                                            name</label>
                                        <div class="mt-1">
                                            <input type="text" name="first-name" id="first-name"
                                                autocomplete="given-name"
                                                class="bg-purple-100 block w-full rounded-md border-gray-300 py-3 px-4 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        </div>
                                    </div>
                                    <div>
                                        <label for="last-name" class="block text-sm font-medium text-gray-900">Last
                                            name</label>
                                        <div class="mt-1">
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <label for="country" class="block text-sm font-medium text-gray-700"> Property
                                            Type: </label>
                                        <div class="mt-5">
                                    ...
                                    <div class="sm:col-span-2 sm:flex sm:justify-end">
                                        <a href="#"
                                            class="inline-flex items-center justify-center whitespace-nowrap rounded-full border border-transparent bg-origin-border bg-purple-500 px-4 py-1 text-base font-medium text-white shadow-sm hover:from-purple-700 hover:to-indigo-700">Send</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
                        ...
                        <div class="pt-8 sm:pt-8 lg:pt-8">
                            ...
                            <div class="mt-10 space-y-6 text-gray-500">
                                <p class="text-lg">{{ env('APP_SECOND_ADDRESS') }}</p>
        ...
        <footer class="bg-gray-50" aria-labelledby="footer-heading">
            ...
            <div class="content-center mx-auto max-w-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
                    ...
                    <div class="grid grid-cols-3 gap-8 xl:col-span-2">
                        ...
                        <div class="md:grid md:grid-cols-1 md:gap-8">
                            <div>
                                ...
                                <ul role="list" class="mt-4 space-y-4">
                                    <li>
                                        <a href="#" class="text-base text-gray-500 hover:text-gray-900">Plans and
                                            Pricing</a>
                                    </li>

                                    <li>
                                        <a href="#" class="text-base text-gray-500 hover:text-gray-900">Quick start
                                            guide</a>
                                    </li>
                        ...
                        <div class="md:grid md:grid-cols-1 md:gap-8">
                            <div>
                                ...
                                <ul role="list" class="mt-4 space-y-4">
                                    <li>
                                        <a href="#" class="text-base text-gray-500 hover:text-gray-900">Acceptable
                                            Use</a>
                                    </li>

                                    <li>
                                        <a href="#" class="text-base text-gray-500 hover:text-gray-900">Privacy
                                            Policy</a>
                                    </li>

                                    <li>
                                        <a href="#" class="text-base text-gray-500 hover:text-gray-900">Terms &
                                            Conditions</a>
                                    </li>
                ...
                <div class="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
                    ...
                    <p class="mt-8 text-base text-gray-400 md:order-1 md:mt-0">&copy; 2022 {{ env('APP_NAME') }} All
                        rights reserved.</p>
                </div>
            </div>
        </footer>
