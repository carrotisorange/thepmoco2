  ...
  <div class="bg-gray-900">
      <div class="mx-auto max-w-4xl py-16 px-4 sm:px-6 sm:py-24 lg:flex lg:max-w-7xl lg:items-center lg:justify-between lg:px-8">
        <h2 class="text-4xl font-bold tracking-tight text-gray-200 sm:text-4xl">
          ...
          <span class="-mb-1 block bg-gradient-to-r from-purple-300 to-indigo-600 bg-clip-text pb-1 text-transparent">Contact Us.</span>
        </h2>
  ...
  <div class="">
    <div class="relative bg-white shadow-xl">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3">
        <!-- Contact information -->
        <div class="px-5 relative overflow-hidden py-10 sm:px-10 xl:p-12" style= "background-image: url('/brands/contact.jpg ');">
        ...
        <div>
          <h2 class="text-3xl font-semibold mb-5">The PMO Co.</h2>
          <p class="text-gray-500">Asian Institute of Management - Dado Banatao Incubator Benavidez Street, Corner Trasierra, Legazpi Village, Makati, 1229 Metro Manila. </p>
</div>
