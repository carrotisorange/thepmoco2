            ...
            <div role="list">
                <div class="slide min-h-screen" id="propman-image">
                    <div id="" class="sm:block lg:flex md:flex min-h-screen py-16">
                        <div
                            class="flex-col items-center  justify-center sm:ml-3 lg:ml-5 px-4 sm:px-4 md:px-8 lg:px-10">
                            ...
                            <div class="max-w-7xl">
                                <div
                                    class="text-center text-gray-300 text-2xl font-bold pt-24 pb-10 sm:text-2xl lg:text-5xl">
                        ...
                        <div
                            class="flex items-center lg:absolute right-0 mx-20 justify-center sm:-py-2 md:py-20 lg:py-8">
                            <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-md sm:ml-12 sm:py-2  mx-5">
                                <p class="text-base font-light mt-10 text-white text-justify">Property Management System
                                    for long term
                                    and short term rental properties and home owners associations.</p>
                                <div class="mt-10 flex justify-center items-center space-x-5">
                                    <button class="propmanOrangebg rounded-full"> <a href="/select-a-plan"
                                            class="w-48 flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-bold text-white  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Free
                                            Trial</a></button>
                ...
                <div class="slide min-h-screen" id="proprent-image">
                    <div id="" class="sm:block lg:flex md:flex min-h-screen py-16">
                        ...
                        <div class="absolute right-0 mx-20 justify-center sm:-py-2 md:py-20 lg:py-8">
                            <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-md sm:ml-12 sm:py-2  mx-5">
                                <p class="text-base font-light mt-10 text-white text-justify">Leasing platform for
                                    rental property
                                    owners to list vacant rooms and units for long term or short term rental and a
                                    Leasing Marketplace for
                                    tenants to find available place.</p>
                                <div class="mt-10 flex justify-end items-center space-x-5">
                                    <button class="rounded-full"> <a href="proprent-search"
                                            class="proprentOrangebg w-48 flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-bold text-white  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Coming
                                            Soon</a></button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="slide min-h-screen" id="propbiz-image">
                    <div id="" class="sm:block lg:flex md:flex min-h-screen py-16">
                        ...
                        <div class="absolute right-0 mx-20 justify-center sm:-py-2 md:py-20 lg:py-8">
                            <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-md sm:ml-12 sm:py-2  mx-5">
                                <p class="text-base font-light mt-10 text-white text-justify">Property management
                                    services that provides
                                    online and onsite operations management services to rental property owners.</p>
                                <div class="mt-10 flex justify-end items-center space-x-5">
                                    <button class="rounded-full"> <a href="propbiz"
                                            class="proprentOrangebg w-48 flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-bold text-white  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Register</a></button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="" class="sm:block lg:flex md:flex min-h-screen py-16">
                        <div
                            ...
                            <div class="max-w-7xl mt-10">
                                <div
                                    class="text-center text-gray-100 text-2xl font-bold pt-24 pb-10 sm:text-2xl lg:text-5xl">
                        ...
                        <div class="absolute right-0 mx-20 justify-center sm:-py-2 md:py-20 lg:py-8">
                            <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-md sm:ml-12 sm:py-2  mx-5">
                                <p class="text-base font-light mt-10 text-white text-justify">We provide full suite
                                    digital solution for
                                    rental property communities and home owners associations.</p>
                                <div class="mt-10 flex justify-end items-center space-x-5">
                                    <button class="propmanOrangebg rounded-full"> <a href="about"
                                            class="w-48 flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-bold text-white  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Learn
                                            More</a></button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="my-8">
                        <ul class="flex justify-center items-center -mb-px space-x-8" id="myTab"
                            ...
                            <li class="mr-2 rounded-xl" role="presentation">
                                <img class="h-72 inline-block border text-gray-500 hover:border-gray-300 rounded-t-lg py-4 px-4 text-sm font-medium text-center border-transparent border-b-2 active"
                            ...
                            <li class="mr-2 rounded-xl" role="presentation">
                                <img class="h-72 inline-block border text-gray-500 hover:text-gray-600 hover:border-gray-300 rounded-t-lg py-4 px-4 text-sm font-medium text-center border-transparent border-b-2 dark:text-gray-400 dark:hover:text-gray-300"
        ...
        setInterval(function() {
          ...
          $("#static").fadeOut(0, function() {
            $(this)
              ...
              .css('color', index % 2 == 0 ? '#F4B700' : '#FFDE59')
              .fadeIn(0);
          });
        }, 1999);
      });
