  ...
  <div class="bg-white">
      ...
      <div class="relative bg-white">
        <div
          ...
          <nav class="hidden space-x-10 md:flex">
            ...
            -->
              <div
                class="hidden absolute z-10 -ml-4 mt-3 w-screen max-w-md transform lg:left-1/2 lg:ml-0 lg:max-w-2xl lg:-translate-x-1/2">
          ...
          <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
            <a href="#"
              class="inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-gradient-to-r from-purple-500 to-indigo-300 bg-origin-border px-4 py-1 text-base font-medium text-white shadow-sm hover:from-purple-700 hover:to-indigo-700">Sign
              up</a>
            <a href="newsignin"
              class="ml-8 whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">Sign in</a>
    ...
    <main class="bg-purple-50">
      ...
      <div class="mx-auto max-w-5xl  py-8 px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl sm:leading-none lg:text-6xl">Start
          simplifying now!</h2>
        <p class="mt-6 max-w-2xl text-xl text-gray-500">Choose the best value for your property size.</p>
        ...
        <div class="mt-10 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:space-y-0">
          <div class="relative flex flex-col rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            <div class="flex-1">
              ...
              <p class="mt-4 flex items-baseline text-gray-900">
                <span class="text-5xl font-bold tracking-tight">₱950</span>
              ...
              <ul role="list" class="mt-6 space-y-6">
                <li class="flex">
                  ...
                  <svg class="h-6 w-6 flex-shrink-0 text-indigo-500" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                  </svg>
                  <span class="ml-3 text-gray-500">Unlimited properties</span>
                </li>
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500">1-20 units</span>
                </li>
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500">1 user</span>
                </li>
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500">Simple Accounting</span>
                </li>
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500">Tenant & Owner portal</span>
                </li>
            ...
            <a href="#"
              class="bg-indigo-50 text-indigo-700 hover:bg-indigo-100 mt-8 block w-full py-3 px-6 border border-transparent rounded-md text-center font-medium">Sign
              Up</a>
          </div>

          <div class="relative flex flex-col rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            <div class="flex-1">
              <h3 class="text-xl font-semibold text-gray-900">Advanced Plan</h3>

              <p
                class="absolute top-0 -translate-y-1/2 transform rounded-full bg-indigo-500 py-1.5 px-4 text-sm font-semibold text-white">
                Most popular</p>
              <p class="mt-4 flex items-baseline text-gray-900">
                <span class="text-5xl font-bold tracking-tight">₱1800</span>
                <span class="ml-1 text-xl font-semibold">/month</span>
              </p>
              ...
              <ul role="list" class="mt-6 space-y-6">
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500">Up to 50 units</span>
                </li>
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500">5 users</span>
                </li>
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500">Accounting</span>
                </li>
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500">Contract management</span>
                </li>
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500">Concerns</span>
                </li>
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500">Maintenance requests</span>
                </li>
            ...
            <a href="#"
              class="bg-indigo-500 text-white hover:bg-indigo-600 mt-8 block w-full py-3 px-6 border border-transparent rounded-md text-center font-medium">Monthly
              billing</a>
          </div>
          ...
          <div class="relative flex flex-col rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            <div class="flex-1">
              ...
              <p class="mt-4 flex items-baseline text-gray-900">
                <span class="text-5xl font-bold tracking-tight">₱2500</span>
                <span class="ml-1 text-xl font-semibold">/month</span>
              </p>
              ...
              <ul role="list" class="mt-6 space-y-6">
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500">Concierge</span>
                </li>
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500">Facilities management</span>
                </li>
            ...
            <a href="#"
              class="bg-indigo-50 text-indigo-700 hover:bg-indigo-100 mt-8 block w-full py-3 px-6 border border-transparent rounded-md text-center font-medium">Monthly
              billing</a>
          </div>
        </div>
      </div>
