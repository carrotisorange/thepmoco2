<x-landing-page-template>
  ...
  <style>
    ...
    .propsuite-daily-bg {
      background-image: url('/brands/propsuite/propsuite-daily-bg.png');
      height: 100%;
  ...
  <div class="pb-10 lg:pb-0 propsuite-daily-bg sm:block lg:flex md:flex min-h-screen">
    <div class="flex-col items-center justify-center sm:ml-3 lg:ml-5 px-4 sm:px-4 md:px-8 lg:px-20 xl:px-36">
      <div class="w-full">
        <div class="text-gray-300 text-4xl font-bold py-24 sm:text-5xl lg:text-5xl">
          <img class="w-36" src="{{ asset('/brands/landing/propsuite-daily.png') }}">
    ...
    <div class="flex-col justify-center sm:-py-2 md:py-20 lg:py-8 lg:px-36 sm-px-0">
      <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-md sm:ml-12 sm:py-2  mx-5">
        <p class="text-base font-light mt-10 text-gray-200 text-justify">PropSuite Daily is ideal for daily rental properties like guest houses, transient homes, airbnb properties, or Mabuhay Accommodations to manage arrival and departure of guests to avoid double bookings. 
	    We professionalize booking and reservations of small rental properties with a guest booking system for confirming reservations, invoicing, and issuing vouchers.
        </p>
      ...
      <div class="mx-auto gap-x-6 gap-y-12 sm:grid grid-cols-2 lg:mt-16 lg:grid-cols-2 lg:gap-x-16 lg:gap-y-16">
        ...
        <div>
          <div class=" lg:py-0 flex items-center justify-start lg:justify-center">
            ...
            <img src="data:image/png;base64,">
            </span>

            <h3 class="ml-5 flex text-xl font-medium text-gray-800">Guest Management</h3>
          </div>

          <div class="pb-6 lg:pb-0 flex justify-center items-center">
            <div class="max-w-xs">
              <div class="text-sm font-light text-gray-600 mt-6">
                <p class=" mt-2">Handle and oversee individuals who are visiting your daily rentals. 
                </p>
              </div>
            </div>
          </div>
        ...
        <div>
          <div class=" lg:py-0 flex items-center justify-start lg:justify-center">
            <span class="ml-0 lg:-ml-32 flex h-12 w-12 items-center justify-center rounded-md bg-white bg-opacity-10">
                <img src="data:image/png;base64,"> 
            </span>
            <h3 class="ml-5 flex text-xl font-medium text-gray-800">Booking Calendar</h3>
          </div>

          <div class="pb-6 lg:pb-0 flex justify-center items-center">
            <div class="max-w-xs">
                <div class="text-sm font-light text-gray-600 mt-6">
                    <p class=" mt-2">Schedule and manage reservations over a specified period of time.
                </div>
            </div>
          </div>
        </div>
