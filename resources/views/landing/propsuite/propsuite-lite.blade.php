<x-landing-page-template>
  ...
  <style>
    ...
    .propsuite-lite-bg {
      background-image: url('/brands/propsuite/propsuite-lite-bg.png');
      height: 100%;
  ...
  <div class="pb-10 lg:pb-0 propsuite-lite-bg sm:block lg:flex md:flex min-h-screen">
    <div class="flex-col items-center justify-center sm:ml-3 lg:ml-5 px-4 sm:px-4 md:px-8 lg:px-20 xl:px-36">
      <div class="w-full">
        <div class="text-gray-700 text-4xl font-bold py-24 sm:text-5xl lg:text-5xl">
          <img class="w-36" src="{{ asset('/brands/landing/propsuite-lite.png') }}">
    ...
    <div class="flex-col justify-center sm:-py-2 md:py-20 lg:py-8 lg:px-36 sm-px-0">
      <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-md sm:ml-12 sm:py-2  mx-5">
        <p class="text-base font-light mt-10 text-gray-600 text-justify">PropSuite Lite is a rental property management system for Long Term Rental Property Communities whether for commercial or residential tenants. We streamline the process of tenant management, making it convenient for landlords to manage their tenants from contract signing up to the whole tenancy period. 
        </p>

        <div class="mt-10 flex justify-center items-center space-x-5">
          <button class=" rounded-full"> <a href="/select-a-plan"
              class="propmanOrangebg border border-gray-500 w-48 flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-bold text-gray-900  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Free
              Trial</a></button>
          <button> <a href="#contactus"
              class="w-48 flex justify-center py-3 px-4 border border-gray-400 rounded-full shadow-sm text-sm font-medium text-white hover:bg-purple-700  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Request Demo</a></button>
        </div>
      </div>
    </div>
  ...
  <div id="features">
    <div class="h-full mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:pt-10 lg:max-w-7xl lg:px-8 lg:pt-10">
      <div class="mx-auto gap-x-6 gap-y-12 sm:grid grid-cols-2 lg:mt-16 lg:grid-cols-3 lg:gap-x-16 lg:gap-y-16">
        ...
        <div>
          <div class=" lg:py-0 flex items-center justify-start lg:justify-center">
            <span class="ml-0 lg:-ml-32 flex h-12 w-12 items-center justify-center rounded-md bg-white bg-opacity-10">
                <img src="data:image/png;base64,">
            </span>

            <h3 class="ml-5 flex text-xl font-medium text-gray-800">Digital Contract</h3>
          </div>

          <div class="pb-6 lg:pb-0 flex justify-center items-center">
            <div class="max-w-xs">
              <div class="text-sm font-light text-gray-600 mt-6">
                <p class=" mt-2">Make it easy for tenants to close contract thru digital contracts.
                </p>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <div class="pb-6 lg:pb-0 flex justify-center items-center">
            <div class="max-w-xs">
                <div class="text-sm font-light text-gray-600 mt-6">
                    <p class=" mt-2">Make billing and collection of rent a breeze with online billing and collection.
                </div>
            </div>
          </div>
        </div>
        ...
        <div>
          <div class=" lg:py-0 flex items-center justify-start lg:justify-center">
            ...
            <h3 class="ml-5 flex text-xl font-medium text-gray-800">Tenant Portal</h3>
          </div>

          <div class="pb-6 lg:pb-0 flex justify-center items-center">
            <div class="max-w-xs">
                <div class="text-sm font-light text-gray-600 mt-6">
                    <p class=" mt-2">Improve customer service and increase transparency with tenants through tenant portal. 
                </div>
            </div>
          </div>
        </div>
