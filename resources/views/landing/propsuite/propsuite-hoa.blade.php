<x-landing-page-template>
  ...
  <style>
    ...
    .propsuite-hoa-bg {
      background-image: url('/brands/propsuite/propsuite-hoa-bg.png');
      height: 100%;
  ...
  <div class="pb-10 lg:pb-0 propsuite-hoa-bg sm:block lg:flex md:flex min-h-screen">
    <div class="flex-col items-center justify-center sm:ml-3 lg:ml-5 px-4 sm:px-4 md:px-8 lg:px-20 xl:px-36">
      <div class="w-full">
        <div class="text-gray-900 text-4xl font-bold py-24 sm:text-5xl lg:text-5xl">
          <img class="w-36" src="{{ asset('/brands/landing/propsuite-hoa.png') }}">
    ...
    <div class="flex-col justify-center sm:-py-2 md:py-20 lg:py-8 lg:px-36 sm-px-0">
      <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-md sm:ml-12 sm:py-2  mx-5">
        <p class="text-base font-light mt-10 text-gray-800 text-justify">PropSuite HOA is a subdivision community management system for home owners associations.
         </p>

        <p class="mt-3 font-semibold">Special rates for DHSUD registered HOAs.</p>  

        <div class="mt-10 flex justify-center items-center space-x-5">
          <button class=" rounded-full"> <a href="https://hoa.propsuite.net/"
              class="propmanOrangebg border border-gray-500 w-48 flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-bold text-gray-800  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Register Now</a></button>
          <button> <a href="#contactus"
              class="w-48 flex justify-center py-3 px-4 border border-gray-400 rounded-full shadow-sm text-sm font-medium text-gray-800 hover:bg-gray-400  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Request Demo</a></button>
        </div>
      </div>
    </div>
      ...
      <div class="mx-auto gap-x-6 gap-y-12 sm:grid grid-cols-2 lg:mt-16 lg:grid-cols-2 lg:gap-x-16 lg:gap-y-16">
        ...
        <div>
          <div class=" lg:py-0 flex items-center justify-start lg:justify-center">
            <span class="ml-0 lg:-ml-32 flex h-12 w-12 items-center justify-center rounded-md bg-white bg-opacity-10">
                <img src="data:image/png;base64,">
            </span>

            <h3 class="ml-5 flex text-xl font-medium text-gray-800">Community Bulletin</h3>
          </div>

          <div class="pb-6 lg:pb-0 flex justify-center items-center">
            <div class="max-w-xs">
              <div class="text-sm font-light text-gray-600 mt-6">
                <p class=" mt-2">Improve communication between management and the HOA members with an online community bulletin.
                </p>
              </div>
            </div>
          </div>
        ...
        <div>
          <div class=" lg:py-0 flex items-center justify-start lg:justify-center">
            ...
            <h3 class="ml-5 flex text-xl font-medium text-gray-800">General Assembly and Election</h3>
          </div>

          <div class="pb-6 lg:pb-0 flex justify-center items-center">
            <div class="max-w-xs">
                <div class="text-sm font-light text-gray-600 mt-6">
                    <p class=" mt-2">Increase participation in General Assembly and Election of officers with PropSuite Election Portal.
                </div>
            </div>
          </div>
        </div>
