            ...
            <div role="list">
                <div class="slide bg-transparent" id="">
                    <div id="" class="sm:block lg:flex md:flex py-5 justify-center items-center">
                        ...
                        <div class="items-center lg: mx-20 justify-center sm:-py-2 md:py-20 lg:py-1">
                            <div
                                class="flex items-center justify-center  sm:justify-center sm:ml-3 lg:ml-5 px-4 sm:px-4 md:px-8 lg:px-10">
                            ...
                            <div class="lg:block lg:pb-20 md:max-w-lg xl:max-w-2xl sm:ml-12 sm:py-2">
                                ...
                                <div class="mt-10 flex justify-center items-center space-x-5">
                                    <button class="rounded-full"> <a href="propbiz"
                                            class="propmanOrangebg w-48 flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-bold text-white  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Register</a></button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="slide bg-transparent" id="">
                    <div id="" class="sm:block lg:flex md:flex py-5 justify-center items-center">
                        ...
                        <div class="lg:block lg:pb-20 md:max-w-lg xl:max-w-2xl sm:ml-12 sm:py-2">
                            <p class="text-base font-light mt-10 text-white text-justify">We provide full suite digital
                                solution for
                                rental property communities and home owners associations.</p>
                            <div class="mt-10 flex justify-center items-center space-x-5">
                                <button class="proprentOrangebg rounded-full"> <a href="about"
