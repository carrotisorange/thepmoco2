...
<nav id="nav" class="lg:sticky top-0 z-10 relative px-4 py-6 flex justify-between items-center">
    ...
    <img class="h-10" src="{{ asset('/brands/landing/pmo-logo.png') }}" alt="pmo logo">
		...
		<a class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-purple-700 hover:bg-purple-500 text-sm text-white  rounded-xl transition duration-200" href="select-a-plan">Sign Up</a>
