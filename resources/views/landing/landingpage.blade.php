...
<!-- pop up modal -->
          <dh-component>         
            <div class="hidden py-5 rounded-lg shadow  bg-gray-700 bg-opacity-75 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0" id="modal">
...
<!-- <div id="propman-bg" class="sm:block lg:flex md:flex min-h-screen py-16">
            ...
            <div class="absolute right-0 mx-20 justify-center sm:-py-2 md:py-20 lg:py-8">
              <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-md sm:ml-12 sm:py-2  mx-5">
                <p class="text-base font-light mt-10 text-white text-justify">We provide full suite digital for rental property communities and home owners associations.</p>
