      ...
      <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
        ...
        <nav class="hidden space-x-10 md:flex">
          <div class="relative">
            ...
            <button type="button" class="text-gray-300 group inline-flex items-center rounded-md text-base font-medium hover:text-gray-900 " aria-expanded="false">
              <h1>Home</h1>
              <!--
        ...
        <button id="button1"><a href="newsignup" class="inline-flex items-center justify-center whitespace-nowrap rounded-full border border-transparent bg-origin-border px-4 py-1 text-sm font-medium text-white shadow-sm">Sign up</a></button>
