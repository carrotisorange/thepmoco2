...
<!-- seamless section -->
          ...
          <div  class="sm:block lg:flex md:flex flex items-center justify-center">
            <div class="flex-col items-center justify-center px-4 sm:px-4 md:px-8 lg:px-20 xl:px-36 p-48">
              <div class="w-full">
                <div id="static" class="text-gray-200 text-center font-bold text-3xl sm:text-4xl md:text-4xl lg:text-6xl px-5 lg:px-0">
            ...
            <div class="-mt-32 pb-56 flex items-center justify-center gap-x-6">
              <p id="" class="this text-lg lg:text-2xl font-light text-gray-100 px-20 lg:px-5">We provide <span class="font-bold">full suite digital solution</span> for rental property communities and home owners associations.</p>
          ...
          <div class="max-w-4xl mx-auto hidden lg:block">
              ...
              <div id="myTabContent" class="mt-10 hidden lg:block">
                  ...
                  <div class="p-4 rounded-lg border " id="profile" role="tabpanel" aria-labelledby="profile-tab">
                      <div class="grid grid-cols-2">
                        <img class="flex-col w-72 justify-center items-center" src="{{ asset('/brands/propsuite/propman.png') }}">
                        <div class="flex-col">
                          <p class="text-gray-500 dark:text-gray-400 text-base text-justify"><span class="font-bold">Property management system</span> as a service that provides a transformative digital solution to simplify operations of long term or short term rental properties. Unlike manual processes, our online system provides real-time, reliable and accessible information to landlords and managers to increase transparency and efficiency of operations. </p>
                            <div class="flex items-center justify-end mt-5">
                              <a href="propman"><button class="bg-yellow-200 hover:bg-yellow-400 p-2 rounded-md text-sm font-bold">Learn More</button></a>
                            </div>
                        </div>
                      </div>
                    </div>

                  <div class="p-4 rounded-lg border hidden" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                      <div class="grid grid-cols-2">
                        <img class="flex-col w-72 justify-center items-center" src="{{ asset('/brands/propsuite/proprent.png') }}">
                        <div class="flex-col">
                          <p class="text-gray-500 dark:text-gray-400 text-base text-justify"><span class="font-bold">Leasing Marketplace</span> for tenants to find available place for long term or short term rentals. Unlike social media pages, we verify the address and the accuracy of the rental space to increase trust in the proprent community. </p>
                            <div class="flex items-center justify-end mt-5">
                              <a href="proprent"><button class="bg-yellow-200 hover:bg-yellow-400 p-2 rounded-md text-sm font-bold">Learn More</button></a>
                            </div>
                        </div>
                      </div>
                  </div>

                  <div class="p-4 rounded-lg border hidden" id="settings" role="tabpanel" aria-labelledby="settings-tab">
                      <div class="grid grid-cols-2">
                        <img class="flex-col w-72 justify-center items-center" src="{{ asset('/brands/propsuite/propbiz.png') }}">
                        <div class="flex-col">
                          <p class="text-gray-500 dark:text-gray-400 text-base text-justify"><span class="font-bold">Property management services</span> that provides online and onsite operations management services to rental property owners. Unlike caretakers, our property and leasing manager partners are professionals using a management system that allows owners to have real time business insights on their rental properties.</p>
                            <div class="flex items-center justify-end mt-5">
                              <a href="propbiz"><button class="bg-yellow-200 hover:bg-yellow-400 p-2 rounded-md text-sm font-bold">Learn More</button></a>
                            </div>
                        </div>
                      </div>
                  </div>
            ...
            <!--  -->
            <div class="block lg:hidden mx-auto mt-12 grid max-w-md gap-8 px-4 sm:max-w-lg sm:px-6 lg:max-w-7xl lg:grid-cols-3 lg:px-8">
