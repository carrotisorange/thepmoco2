    ...
    <body id="background">
        ...
        <div class="sm:block lg:flex md:flex flex items-center justify-center">
            <div class="flex-col items-center justify-center px-4 sm:px-4 md:px-8 lg:px-20 xl:px-36 p-48">
                <div class="w-full">
                    <div id="static"
                        class="text-gray-200 text-center font-bold text-3xl sm:text-4xl md:text-4xl lg:text-6xl px-5 lg:px-0">
        ...
        <div class="-mt-32 pb-56 flex items-center justify-center gap-x-6">
            <p id="" class="this text-lg lg:text-2xl font-light text-gray-100 px-20 lg:px-5">We provide <span
                    class="font-bold">full suite digital solution</span> for rental property communities and home owners
                associations.</p>
