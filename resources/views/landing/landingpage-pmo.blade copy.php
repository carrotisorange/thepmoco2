<x-landing-page-template>
    ...
    <blade
        section|(%26%2339%3Bdescription%26%2339%3B%2C%20%26%2339%3BIncrease%20transparency%2C%20and%20efficiency%20in%20rental%20property%20operations%20with%20a%20simple%20and%20easy%20to%20use%20system%20for%20leasing%20and%20property%20management.%26%2339%3B) />
    ...
    <!-- pop up modal -->
    <dh-component>
        <div class="py-5 rounded-lg shadow  bg-gray-700 bg-opacity-75 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0"
            id="modal">
                ...
                <div class="mt-24 relative py-3 px-5 md:px-10 shadow-2xl bg-white ">
                    ...
                    <div id="modal-bg" class="px-3 md:px-4 py-6 flex flex-col justify-center items-center">
                        ...
                        <div class="mt-12 md:mt-14 w-full flex justify-center">
                            <a href="{{ env('APP_URL') }}/select-a-plan"><button
    ...
    <div class="sm:block lg:flex md:flex min-h-screen">
        ...
        <div class="flex-col justify-center sm:-py-2 md:py-20 lg:py-8 lg:px-16 sm-px-0 ">
            <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-3xl sm:ml-12 sm:py-2 lg:-ml-5 mx-5">
                <p class="text-lg font-light mt-10 text-white">With The Property Manager Online, you can easily
                    streamline rental property operations smoothly and harmoniously with your tenants while saving time
                    and money!</p>

                <div class="mt-10 flex justify-center items-center space-x-5">
                    <button id="button1"> <a href="{{ env('APP_URL') }}/select-a-plan"
    ...
    <div id="owner" class="mt-0 sm:mt-0 lg:-mt-56  min-h-full lg:grid  lg:grid-cols-2 lg:gap-8 lg:px-8 bg-white">
        ...
        <div class="lg:col-start-1 lg:m-0 lg:pl-20">
            <div
                class="pb-5 px-5 sm:px-20 md:px-20 lg:px-0 sm:max-w-xl  lg:max-w-none  flex items-center justify-center">
                <span class="text-2xl font-semibold text-gray-700">Turn your property into an income generating <br>real
                    asset!</span>
        ...
        <div class="sm:pl-20 px-5 sm:px-20 md:px-20 lg:px-20 lg:py-10 sm:mt-0  lg:col-start-2">
            ...
            <div class="flex justify-center items-center">
                <p class="pb-10 text-base font-light text-gray-700">
                    Are you a <span class="font-bold text-purple-900">rental property owner</span> in need of <span
                        class="font-bold text-purple-900">property management services?</span>
                    Sign up as a property owner and we will connect you to our pool of property managers.
                </p>
            </div>


            <button id="owner-btn"> <a href="owner-corner"
                    class="w-full flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-medium text-white   focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">I
                    need property management services</a></button>
                    ...
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <h1 class="p-5 text-white text-lg text-center font-semibold">Manage multiple properties
                                    in one seamless and unified system</h1>
                                <img width="1920" height="1080"
                                    src="{{ asset('/brands/landing/portfolio_img.webp') }}"
                                    alt="portfolio page showing 4 buildings" />
                            </div>
                            <div class="swiper-slide">
                                <h1 class="p-5 text-white text-lg text-center font-semibold">A property dashboard for
                                    property performance metrics at a glance</h1>
                                <img width="1920" height="1080"
                            ...
                            <div class="swiper-slide">
                                <h1 class="p-5 text-white text-lg text-center font-semibold">Easily collaborate with a
                                    centralized database for the management team</h1>
                                <img width="1920" height="1080"
            ...
            <div class="gap-x-6 gap-y-12 sm:grid grid-cols-2 lg:mt-16 lg:grid-cols-3 lg:gap-x-16 lg:gap-y-16">
                ...
                <div>
                    <div class="flex items-center justify-center">
                        <span
                            class="-ml-32 flex h-12 w-12 items-center justify-center rounded-md bg-white bg-opacity-10">
                        ...
                        <div class="max-w-xs">
                            <div class="text-xs mt-6">
                                <p class=" mt-2">Manage all of your tenants&#39; rent payments and check
                                    up on them from anywhere in the world. You&#39;ll also be able to see when
                                    they&#39;re late on their rent, so
                                    you can take action right away. You can view their payment history and make
                                    payments.
                                </p>
                            </div>
                        </div>
                ...
                <div>
                    <div class="flex items-center justify-center">
                        <span
                            class="-ml-16 flex h-12 w-12 items-center justify-center rounded-md bg-white bg-opacity-10">
                    ...
                    <div class="flex justify-center items-center ">
                        <div class="max-w-xs">
                            <div class="text-xs mt-6">
                                ...
                                <p class="mt-2">Track all of your bills and payments with one convenient portal so that
                                    all of your
                                    invoices and payments are in one place. You&#39;ll also be able to generate reports
                                    automatically that show
                ...
                <div>
                    <div class="flex items-center justify-center">
                        <span
                            class="-ml-2  flex h-12 w-12 items-center justify-center rounded-md bg-white bg-opacity-10">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-8 h-8">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="max-w-xs">
                            <div class="text-xs mt-6">
                                <p class="mt-2">Keep track of all of your
                                    expenses! we&#39;ll create a report showing how much money was spent on your
                                    property.
                                </p>
                            </div>
                        </div>
                ...
                <div>
                    <div class="flex items-center justify-center">
                        ...
                        <h3 class="ml-5 flex text-center text-lg font-medium text-gray-600">System Generated Reports
                        </h3>
                    </div>
                    ...
                    <div class="flex justify-center items-center">
                        <div class="max-w-xs">
                            <div class="text-xs mt-6">
                                <p class="mt-2">Without the decision support system, decision making would be difficult.
                                    The property management
                                    system helps you to make the right decision at right time with its system generated
                                    reports.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="flex items-center justify-center">
                        <span
                            class="-ml-20 flex h-12 w-12 items-center justify-center rounded-md bg-white bg-opacity-10">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-8 h-8">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="flex justify-center items-center">
                        <div class="max-w-xs">
                            <div class="text-xs mt-6">
                                <p class="mt-2">This dashboard shows all of your portfolio&#39;s current prices—and what
                                    they would be if they were sold
                                    off individually. With the property management system, you can manage multiple
                ...
                <div>
                    <div class="flex items-center justify-center">
                        <span
                            class="-ml-10 flex h-12 w-12 items-center justify-center rounded-md bg-white bg-opacity-10">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-8 h-8">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="flex justify-center items-center">
                        <div class="max-w-xs">
                            <div class="text-xs mt-6">
                                <p class="mt-2">This portal allows you to manage units within your portfolio—and even
                                    take advantage of special offers
                                    for new units. It allows you to compare property metrics like frequency of
                                    occupancy, collection
                                    efficiency, number of concerns received, etc to improve performance and business
                                    growth.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-1 flex-col justify-between bg-white p-6">
                        ...
                        <div class="flex-1">
                            ...
                            <a class="mt-2 block">
                                ...
                                <p class="mt-3 text-sm text-gray-500">To kickstart the procedure register your
                                    condominiums, apartments, business spaces, residential units,
                    ...
                    <div class="flex flex-1 flex-col justify-between bg-white p-6">
                        <div class="flex-1">
                            ...
                            <a class="mt-2 block">
                                ...
                                <p class="mt-3 text-sm text-gray-500">Include all details of the property, room
                                    specifications, rent details, deposit requirements, and other
                    ...
                    <div class="flex flex-1 flex-col justify-between bg-white p-6">
                        <div class="flex-1">
                            ...
                            <a class="mt-2 block">
                                ...
                                <p class="mt-3 text-sm text-gray-500">Insert the tenant’s details like contact
                                    information, duration and terms of the contract, and other
                    ...
                    <div class="flex flex-1 flex-col justify-between bg-white p-6">
                        <div class="flex-1">
                            ...
                            <a class="mt-2 block">
                                ...
                                <p class="mt-3 text-sm text-gray-500">Portal provides you with an interface where you
                                    can supervise and manage all concerns of tenants, job
                                    creation, and assignments, supervision of such tasks and monitor them up to
                                    completion.</p>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-1 flex-col justify-between bg-white p-6">
                        <div class="flex-1">
                            ...
                            <a class="mt-2 block">
                                ...
                                <p class="mt-3 text-sm text-gray-500">Setup billing date, recurring charges, and
                                    recurring billing amount property management system will
                                        ...
                                        <blockquote class="mt-10">
                                            <div
                                                ...
                                                <p>&ldquo;It makes my life less stressful because the application
                                                    provides an easy way for tenants to report concerns, and as I
                                                    resolve the concern, it provides an option for them to monitor its
                                                    status in real-time.&rdquo;</p>
                                            </div>
                                            ...
                                            <footer class="mt-8">
                                                <div class="md:flex md:items-center md:justify-center">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="text-base font-medium text-gray-500">Admin, North
                                                            Cambridge</div>
                                                    </div>
                                                </div>
                                            </footer>
                                ...
                                <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                                    ...
                                    <div class="relative">
                                        <img class="mx-auto w-20 h-20"
                                            src="{{ asset('/brands/clients/client-3.png') }}"
                                            alt="Martha logo">
                                        <blockquote class="mt-10">
                                            <div
                                                class="mx-auto max-w-3xl text-center text-xl font-medium leading-9 text-gray-900">
                                            ...
                                            <footer class="mt-8">
                                                <div class="md:flex md:items-center md:justify-center">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="text-base font-medium text-gray-500">Daily Rental
                                                            Property</div>
                                                    </div>
                                                </div>
                                            </footer>
            ...
            <div class="relative bg-white shadow-xl">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3">
                    ...
                    <div class="px-5 relative overflow-hidden bg-gray-700 py-10 sm:px-10 xl:p-12">
                        ...
                        <p class="mt-6 max-w-3xl text-sm text-purple-200">Makati Address: <p
                                class="text-base mt-2 text-white">{{ env('APP_SECOND_ADDRESS') }}
                            </p>
                        </p>
                        <p class="mt-6 max-w-3xl text-sm text-purple-200">Baguio Address: <p
                                class="text-base mt-2 text-white">{{ env('APP_FIRST_ADDRESS') }}</p>
                        </p>
                        ...
                        <div class="mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:px-8">
                            ...
                            <div class="mt-6 grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-4">
                                <div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                                    <a
                                        href="https://www.digitalocean.com/trust/certification-reports?fbclid=IwAR3qJ79YUNro9Px4ycCvcuCgGH7MVxbcrvQitnhlh4i51su4PuJsRyKr6T0"><img
                                            class="w-20 h-20"
                                            src="{{ asset('/brands/landing/digital-ocean.png') }}"
                                            alt="digital ocean logo"></a>
                                </div>
                                <div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                                    <img class="w-30 h-20"
                                        src="{{ asset('/brands/landing/aim-logo.png') }}"
                                        alt="AIM logo">
                                </div>
                                <div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                                    <img class="w-20 h-20"
                                ...
                                <div class="col-span-1 flex justify-center md:col-span-2 md:col-start-2 lg:col-span-1">
                                    <img class="w-20 h-20"
                                        src="{{ asset('/brands/clients/client-4.png') }}"
                                        alt="cura logo">
                                </div>
                            </div>
                        </div>
