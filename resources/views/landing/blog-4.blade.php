...
<div class="mx-10 mt-4 flex justify-end items-center space-y-2 text-xs sm:space-y-0 sm:space-x-3 ">
	<span class="block">Page 4 of 4</span>
	<div class="space-x-1">
  ...
  <div class="relative mx-auto max-w-6xl">
    ...
    <div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
        <div class="flex-shrink-0">
          <a href="How-to-use-a-leasing-management-system-to-improve-operational-efficiency"><img class="h-48 w-full object-cover" src="{{ asset('/brands/landing/article2.jpg') }}" alt="three people looking laptop property management system"></a>
        </div>
        <div class="flex flex-1 flex-col justify-between bg-white p-6">
          <div class="flex-1">
            <p class="text-sm font-medium text-indigo-600">
              <a href="How-to-use-a-leasing-management-system-to-improve-operational-efficiency" class="hover:underline">Article</a>
            </p>
    ...
    <div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
        <div class="flex-shrink-0">
          <a href="/How-The-PMO-Started"><img class="h-48 w-full object-cover" src="https://images.unsplash.com/photo-1496128858413-b36217c2ce36?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1679&q=80" alt="a desk with a keyboard, mouse, phone, and office supplies"></a>
        </div>
        <div class="flex flex-1 flex-col justify-between bg-white p-6">
          <div class="flex-1">
            <p class="text-sm font-medium text-indigo-600">
              <a href="/How-The-PMO-Started" class="hover:underline">Article</a>
            </p>
