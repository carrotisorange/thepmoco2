    ...
    <div id="calendar-list" class="bg-white rounded-lg shadow-lg p-3 mt-12">
        ...
        <ol class="mt-2 divide-y divide-gray-200 text-sm leading-6 text-gray-500">
            ...
            <li class="py-4 sm:flex">
                ...
                <p class="flex-none sm:ml-6"><time datetime="2022-01-13T14:30">Check In</time> - <time datetime="2022-01-13T16:30">Check Out</time></p>
            </li>
            <li class="py-4 sm:flex">
                <time datetime="2022-01-20" class="w-28 flex-none">Fri, Jan 14</time>
                <p class="ml-5 mt-2 flex-auto font-semibold text-gray-900 sm:mt-0">Guest name</p>
                <p class="flex-none sm:ml-6"><time datetime="2022-01-17T10:00">Check In</time> - <time datetime="2022-01-17T10:15">Check Out</time></p>
            </li>
            <li class="py-4 sm:flex">
