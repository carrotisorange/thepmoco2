...
<body>
    ...
    <main class="mx-auto max-w-4xl px-6">
        ...
        <div class="block text-base pt-8">
            <p class="font-light border-b py-1 text-sm">Tenant: <span class="ml-2 font-semibold tracking-widest">Juan
                    Dela Cruz</span></p>
            <p class="font-light border-b py-1 text-sm">Bills to be Paid: <span
                    class="ml-2 font-semibold tracking-widest">12, 000</span></p>
            <p class="font-light border-b py-1 text-sm">Bills to be Paid after Due Date: <span
                    class="ml-2 font-semibold tracking-widest">16,234</span></p>
        </div>
            ...
            <div class="flow-root">
                <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tbody class="bg-white">
                                <tr class="even:bg-gray-50">
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">October - November
                                    </td>
                        ...
                        <p class="flex justify-end font-light py-6 text-sm">Printed by: <span
                                class="font-semibold ml-1"> Demo</span></p>
                    </div>
                </div>
            </div>
