<x-new-layout>
    <div class="mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 xl:py-10">
                ...
                <ol role="list" class="overflow-hidden rounded-md lg:flex lg:rounded-none lg:border-l lg:border-r lg:border-gray-200">
                    ...
                    <li class="relative overflow-hidden lg:flex-1">
                        <div class="border border-gray-200 overflow-hidden border-b-0 rounded-t-md lg:border-0">
                            <!-- Current Step -->
                            @if($subfeature == 'InternalDocument' || $subfeature == 'Approval(Manager)' || $subfeature ==
                            'Approval(AccountPayable)' || $subfeature == 'Payment' || $subfeature == 'Liquidation' || $subfeature == 'LiquidationApproval(Manager)')
                          <x-previous-step-stepper-component
                            ...
                            @elseif($subfeature == 'ChartofAccount(AccountPayable)')
        ...
        @livewire('account-payable-create-step7-component', ['accountpayable' => $accountpayable])
    </div>
</x-new-layout>
