            ...
            <div class="mt-10 px-4 sm:px-6 lg:px-8">
                <div class="sm:flex sm:items-center">
                    ...
                    <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                        {{-- <x-button onclick="window.location.href='/property/{{ Session::get('property_uuid') }}/election/create'">
                            New Election
                        </x-button> --}}
...
{{--
                ...
                <ol role="list" class="mx-auto flex w-full max-w-screen-xl space-x-4 px-4 sm:px-6 lg:px-8">
                    ...
                    <li class="flex">
                        <div class="flex items-center">
                            ...
                            <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page">Policy Form</a>
                        </div>
                    </li>
            ...
            @livewire('election-create-component')
        </div>
    </div>
</x-new-layout>
