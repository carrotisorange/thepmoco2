...
body {
  ...
  #gradient {
  background-image: linear-gradient(to right, rgba(151,90,182), rgba(79,63,109));
  }
...
<body>
    ...
    <img class="h-12" src="{{ asset('/brands/propsuite/propsuite-gray.png') }}" alt="the pmo logo">
      ...
      <li><a class="text-base font-medium text-gray-200 hover:text-gray-400" href="owner-corner">Property Owners Corner</a></li>
		...
		<a class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 propmanOrangebg hover:bg-gray-100 text-sm font-bold text-white hover:bg-gray-300  rounded-2xl transition duration-200" href="https://thepmo.co/select-a-plan">Sign Up</a>
            ...
            <div class="flex-col justify-center sm:-py-2 md:py-20 lg:py-8 lg:px-48 sm-px-0">
              <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-md sm:ml-12 sm:py-2  mx-5">
                ...
                <div class="mt-10 flex justify-center items-center space-x-5">
                  <button class="propmanOrangebg rounded-full"> <a href="https://thepmo.co/select-a-plan" class="w-48 flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-medium text-white  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Free Trial</a></button>
