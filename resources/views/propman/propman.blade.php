            ...
            <div class="flex-col justify-center sm:-py-2 md:py-20 lg:py-8 lg:px-36 sm-px-0">
              <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-md sm:ml-12 sm:py-2  mx-5">
                ...
                <div class="mt-10 flex justify-center items-center space-x-5">
                  <button class=" rounded-full"> <a href="https://thepmo.co/select-a-plan" class="propmanOrangebg w-48 flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-bold text-white  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Free Trial</a></button>
