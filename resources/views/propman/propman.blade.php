<x-landing-page-template>
  ...
  <div class="propman-bg sm:block lg:flex md:flex min-h-screen">
    <div class="flex-col items-center justify-center sm:ml-3 lg:ml-5 px-4 sm:px-4 md:px-8 lg:px-20 xl:px-36">
      <div class="w-full">
        <div class="text-gray-300 text-4xl font-bold py-24 sm:text-5xl lg:text-5xl">
          <img class="w-36" src="{{ asset('/brands/propsuite/propman.png') }}">
    ...
    <div class="flex-col justify-center sm:-py-2 md:py-20 lg:py-8 lg:px-36 sm-px-0">
      <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-md sm:ml-12 sm:py-2  mx-5">
        <p class="text-base font-light mt-10 text-white text-justify">Property management system as a service that
          ...
          properties. Unlike manual processes, our online system provides real-time, reliable and accessible information
          ...
          <div class="swiper mySwiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <h1 class="p-5 text-white text-lg text-center font-semibold">Manage multiple properties in one seamless
              ...
              <div class="swiper-slide">
                <h1 class="p-5 text-white text-lg text-center font-semibold">A property dashboard for property
              ...
              <div class="swiper-slide">
                <h1 class="p-5 text-white text-lg text-center font-semibold">Easily collaborate with a centralized
            ...
            <div class="swiper-wrapper">
                  ...
                  <div class="relative">
                    ...
                    <blockquote class="mt-10">
                      <div class="mx-auto max-w-3xl text-center text-xl font-medium leading-9 text-gray-900">
                        <p>&ldquo;It makes my life less stressful because the application provides an easy way for
                          tenants to report concerns, and as I resolve the concern, it provides an option for them to
                      ...
                      <footer class="mt-8">
                        <div class="md:flex md:items-center md:justify-center">
                          <div class="md:flex-shrink-0">
                            <img class="mx-auto h-10 w-10 rounded-full" src="{{ asset('/brands/landing/f-icon.webp') }}"
                              alt="user icon">
                          </div>
                          <div class="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                            <div class="text-base font-medium text-gray-900">Kate</div>
                            <svg class="mx-1 hidden h-5 w-5 text-indigo-400 md:block" fill="currentColor"
                              viewBox="0 0 20 20">
              ...
              <div class="swiper-slide">
                <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                  <svg
                    class="absolute top-full right-full translate-x-1/3 -translate-y-1/4 transform lg:translate-x-1/2 xl:-translate-y-1/2"
                    width="404" height="404" fill="none" viewBox="0 0 404 404" role="img" aria-labelledby="svg-martha">
