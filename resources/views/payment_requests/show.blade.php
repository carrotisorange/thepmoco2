<x-new-layout>
    ...
    <div class="mt-8">
        <div class="max-full mx-auto sm:px-6">
            ...
            <form
                action="/{{auth()->user()->role_id}}/tenant/{{ auth()->user()->username }}/payments_request/{{ $paymentRequest->batch_no }}/update"
                        ...
                        <div class="shadow sm:rounded-md sm:overflow-hidden">
                            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-3 sm:col-span-2">
                                        <label for="tenant_uuid" class="block text-sm font-medium text-gray-700">Name of
                                            Tenant</label>
                                        <input type="text" name="tenant_uuid" id="tenant_uuid"
                                    ...
                                    <div class="sm:col-span-3">
                                        <fieldset>
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <textarea id="bill_nos" name="bill_nos" rows="3"
                                    ...
                                    <div class="sm:col-span-6">
                                        <fieldset>
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <textarea id="reason_for_rejection" name="reason_for_rejection"
                                                        rows="10" required
                                                        class="h-8 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-700 rounded-md"
                                                        placeholder="">
                                ...
                                <div class="px-4 py-3 text-right sm:px-6">
                                  ...
                                  <a class="whitespace-nowrap px-3 py-4 text-sm text-blue-500 text-decoration-line: underline" target="_blank"
                                    href="/property/{{ Session::get('property') }}/tenant/{{ $paymentRequest->tenant_uuid }}/bills">
                                    Pay Bills
                                </a>
                                        <button type="submit"
                                        class="inline-flex justify-end py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Approve</button>
                                </div>
                            </div>
                    </form>
                </div>
