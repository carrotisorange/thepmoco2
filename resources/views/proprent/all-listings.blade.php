	...
	<div class=" flex items-center justify-between pb-6">
		...
		<div class="flex items-center justify-between">
			<div class="flex bg-gray-50 items-center p-2 rounded-md">
                ...
                <button onClick="location.href='/proprent/upload-listing'" class="bg-yellow-300 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded">Create New Listing</button>
                </div>
			</div>
		</div>
		<div>
