    ...
    <nav id="nav" class="lg:sticky top-0 z-10 relative px-4 py-5 flex justify-between items-center">
        ...
        <ul class="hidden space-x-2 lg:inline-flex items-center">
            ...
            <li class="rounded-2xl py-1">
                <a href="proprent-coming-soon" class="text-purple-900 text-base font-bold flex items-center px-2 hover:text-yellow-300">
                    Sign In
                </a>
            </li>
...
<form>
    <div class="pt-10 flex">
        ...
        <div class="relative w-full">
            ...
            <button type="submit" id="purple" onClick="location.href='proprent-coming-soon'" class="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-red-300 rounded-r-lg border border-red-100 hover:bg-red-200 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
