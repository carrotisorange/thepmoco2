...
<body>
    ...
    <img class="h-12" src="{{ asset('/brands/propsuite/propsuite-gray.png') }}" alt="the pmo logo">
      ...
      <li><a class="text-base font-medium text-gray-200 hover:text-gray-400" href="owner-corner">Property Owners Corner</a></li>
		...
		<a class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 proprentOrangebg hover:bg-gray-100 text-sm font-bold text-white hover:bg-gray-300  rounded-2xl transition duration-200" href="https://thepmo.co/select-a-plan">Sign Up</a>
