        ...
        <div class="mt-5 px-4 sm:px-6 lg:px-8">
            ...
            <form class="space-y-6" wire:submit.prevent="submitForm()" method="POST">
                ...
                <div class="md:grid md:grid-cols-6 md:gap-6">
                    ...
                    <button type="button" class="ml-3 bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Comment</button>
