<x-new-layout>
    @section('title','Step 4 of Step 4 | Moveout')
    <div class="mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 xl:py-10">
                        ...
                        <div class="border border-gray-200 overflow-hidden border-b-0 rounded-t-md lg:border-0">
                            ...
                            <a href="" class="group">
                                ...
                                <span class="px-6 py-5 flex items-start text-sm font-medium">
                                    ...
                                    <span class="mt-0.5 ml-4 flex min-w-0 flex-col">
                                        <span class="text-sm font-medium text-purple-600">Step 3:</span>
                        ...
                        <div class="border border-gray-200 overflow-hidden border-b-0 rounded-t-md lg:border-0">
                            ...
                            <a href="" class="group">
                                ...
                                <span class="px-6 py-5 flex items-start text-sm font-medium">
                                    ...
                                    <span class="mt-0.5 ml-4 flex min-w-0 flex-col">
                                        <span class="text-sm font-medium text-purple-600">Step 4:</span>
        ...
        <div class="mt-5 px-4 sm:px-6 lg:px-8">
            {{-- start-step-3-form --}}
            @livewire('contract-moveout-step4-component', ['contract' => $contract])
            {{-- end-step-3-form --}}
        </div>
    </div>
</x-new-layout>