                            ...
                            <div class="bg-white overflow-hidden shadow rounded-lg">
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-4 sm:grid-cols-3">
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <div
                                            class="mt-2 text-xs text-center font-semibold font-body text-gray-500 truncate">
                                            Contract</div>
                                        <a href=#
                                            class="flex items-center justify-center text-indigo-600 text-lg">30</a>
                                ...
                                <div class="p-5">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-0 w-0 flex-1">
                                            <dl>
                                                <dt class="text-sm font-medium text-gray-500 truncate">Friday, August
                                                    19, 2022</dt>
                                                <dd>
