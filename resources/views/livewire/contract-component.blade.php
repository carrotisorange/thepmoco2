                    ...
                    <form method="POST" wire:submit.prevent="submitForm" enctype="multipart/form-data"
                        ...
                        <div class="flex flex-wrap mx-3 mb-6">
                            ...
                            <div class="w-full md:w-1/3 px-3">
                                ...
                                <x-form-input wire:model="rent" id="rent" type="number" value="{{ $rent }}" name="rent"
                                    readonly />
                                ...
                                <div>
                                    <div class="form-check">
                                        <input wire:model="sendContract"
                                            ...
                                            type="checkbox" value="{{ old('sendContract'), $sendContract }}"
                                            name="sendContract" id="flexCheckChecked">
