        ...
        <div class="sm:flex sm:items-center">
           ...
           @if($propertyHousesCount)
            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                ...
                <x-button name="newUnitModal" type="button" data-modal-toggle="instructions-create-house-modal">New house
                </x-button>
                   ...
                   <div class="sm:col-span-6">
                    ...
                    {{-- <div class="sm:col-span-2">
                        <x-form-select name="limitDisplayTo" id="small" wire:model="limitDisplayTo">
                            ...
                            @for ($i = 1; $i <= $totalHousesCount; $i++)
                                @if($i%10==0 || $i==$totalHousesCount)
