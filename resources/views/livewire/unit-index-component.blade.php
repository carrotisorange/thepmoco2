        ...
        <ol role="list" class="divide-y divide-gray-300 rounded-md border border-gray-300 md:flex md:divide-y-0">
            ...
            <li class="relative md:flex md:flex-1">
                ...
                <a href="#" class="flex items-center px-6 py-4 text-sm font-medium" aria-current="step">
                    ...
                    <span class="ml-4 text-sm font-medium text-indigo-600">Add units</span>
                </a>
    ...
    <div class="sm:flex sm:items-center">
        ...
        <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
            ...
            <button type="button"
                ...
                class="inline-flex items-center justify-center rounded-md border border-transparent bg-purple-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 sm:w-auto">Edit
                Units</button>
            @endif
        </div>
    </div>
