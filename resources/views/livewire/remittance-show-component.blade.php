                        ...
                        <div class="w-0 flex-1 pt-0.5">
                            <div class="grid grid-cols-2">
                                ...
                                <p class="mt-1 text-sm font-base text-gray-500">
                                    {{ number_format($remittance->monthly_rent+ $remittance->marketing_fee+
                                    $remittance->management_fee, 2)}}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center px-8 py-5 border-b">
                        <div class="w-0 flex-1 pt-0.5">
                            ...
                            <div class="grid grid-cols-3 space-x-5">
                                ...
                                <input wire:model="miscellaneousFeeDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                ...
                                <input wire:model="membershipFeeDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="condoDuesDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="parkingDuesDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="waterDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="electricityDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="generatorShareDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="surchargesDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="buildingInsuranceDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="realPropertyTaxDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="housekeepingFeeDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="laundryFeeDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="complimentaryDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="internetDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="specialAssessmentDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="materialRecoveryFacilityDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="rechargeOfFireExtinguisherDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="environmentalFeeDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="bladderTankDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
                                ...
                                <input wire:model="causeOfMagnetDescription"
                                    wire:change='updateRemittance({{ $remittance->id }})'
                                    class="w-full text-xs border border-gray-400 py-2 my-2" />
                                <p class="flex-col mt-1 px-6 py-2 text-sm font-base text-gray-500">
