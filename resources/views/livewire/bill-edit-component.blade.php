    ...
    @include('layouts.notifications')
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-3xl font-bold text-gray-500">Guest / {{ $bill->guest->guest }} / Bill # {{ $bill->bill_no }}</h1>
            </div>
        ...
        <div class="mx-10">
            <div class="px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                            <table class="min-w-full divide-y divide-gray-300">
                                <thead>
                                    <tr>
                                        <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0">BIll
                                            No
                                        </th>
                                    ...
                                    <tr>
                                        <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0">Particular
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                           <select wire:model="particular_id"
                                                ...
                                                @foreach ($particulars as $particular)
                                                    <option value="{{ $particular->particular_id }}" {{ $particular->particular_id == $particular_id ? 'selected' : 'selected' }}>
                                    ...
                                    <tr>
                                        <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0">Start
                                    ...
                                    <tr>
                                        <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0">End
                                    ...
                                    <tr>
                                        <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0">Amount
                ...
                <div class="col-start-6 flex items-center justify-end">
                    ...
                    <button type="button" wire:loading.remove wire:click="updateBill"
                        class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-purple-500 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
