            ...
            <ol role="list" class="mx-auto flex w-full max-w-screen-xl space-x-4 px-4 sm:px-6 lg:px-8">
                ...
                <li class="flex">
                    <div class="flex items-center">
                        ...
                        <a href="/property/{{ Session::get('property_uuid') }}/guest/{{ $guest->uuid }}"
                            class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">{{ $guest->guest }}</a>
                    </div>
                </li>
                ...
                <li class="flex">
                    <div class="flex items-center">
                        ...
                        <a href="/property/{{ Session::get('property_uuid') }}/guest/{{ $guest->uuid }}/bills"
