                ...
                <li class="relative md:flex md:flex-1">
                    ...
                    <a href="#" class="group flex items-center">
                        <span class="flex items-center px-6 py-4 text-sm font-medium">
                            ...
                            <span class="ml-4 text-sm font-medium text-gray-500 group-hover:text-gray-900">Add employees
        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <div class="mt-1 mb-5 grid grid-cols-5 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                ...
                <div class="group relative">
                    ...
                    <h3 class="text-medium sm:text-xs text-gray-700 font-semibold text-center">{{
