<form action="/property/{{ $property->uuid }}/update" method="POST" id="edit-form" enctype="multipart/form-data">
    @csrf
    @method('PATCH')
    <div class="mx-5">
        <x-label for="property" :value="__('Property')" />

        <x-form-input form="edit-form" type="text" name="property" value="{{old('property', $property)}}" required
            autofocus />
    ...
    <div class="mt-5 flex mx-5">
        <div class="flex-3">
            ...
            <x-form-input form="edit-form" id="tenant_contract" type="file" name="tenant_contract"
