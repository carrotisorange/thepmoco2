    ...
    <div class="p-5">
        <form wire:submmit.prevent="updateContract()">
                        <div class="mt-5 sm:mt-6">
                            ...
                            <x-form-input type="text" readonly value="{{ App\Models\Tenant::find($contract->tenant_uuid)->tenant }}"/>
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="tenant_contract"
                                            ...
                                            <input id="tenant_contract" name="tenant_contract" type="file" wire:model="tenant_contract"
                                                class="sr-only">
                                        </label>
