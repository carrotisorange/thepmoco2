        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div>
                        <form method="POST" wire:submit.prevent="createForm" 
                        ...
                        enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <x-input wire:model="property"
                                    id="property" class="block mt-1 w-full" type="text" name="property"
                            ...
                            <div class="mt-5">
                                ...
                                <x-input wire:model="thumbnail" 
                                id="thumbnail" class="block mt-1 w-full" type="file" name="thumbnail"
