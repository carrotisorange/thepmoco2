<div>
   <form class="space-y-3" method="POST" wire:submit.prevent="create()">
      <div class="pt-10">
         <div>
            <h3 class="mb-10 mt-10 text-center text-4xl font-bold leading-6 text-gray-900">Create a new property</h3>
         ...
         <div class="sm:col-span-3">
            ...
            <div class="mt-5">
               <select autocomplete="type_id" wire:model.lazy="type_id"
                  class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block h-8 w-full sm:text-md border-gray-300 rounded-md">
