            ...
            <div class="mt-8 lg:col-span-9">
                <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab"
                        ...
                        <li class="mr-2" role="presentation">
                            <button
                                class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                                id="remittance-summary-tab" data-tabs-target="#remittance-summary" type="button"
                                role="tab" aria-controls="remittance-summary" aria-selected="false">Remittance
                                Summary</button>
                        </li>
                    </ul>
                </div>
                <div id="myTabContent">
                    ...
                    <div class="hidden p-4 purple rounded-lg dark:bg-gray-800" id="inventories" role="tabpanel"
                        ...
                        <button type="button"
                            onclick="window.location.href='/property/{{ Session::get('property_uuid') }}/unit/{{ $unit_details->uuid }}/inventory/{{ Str::random(8) }}/create'"
                            ...
                            <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                ...
                                <div
                                    ...
                                    <div class="mt-10 text-center mb-10">
                                        ...
                                        <div class="mt-6">
                                            <button type="button"
                                                onclick="window.location.href='/property/{{ Session::get('property_uuid') }}/unit/{{ $unit_details->uuid }}/owner/{{ Str::random(8) }}/create'"
                                                class="inline-flex items-center rounded-md border border-transparent bg-purple-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
                            ...
                            <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                ...
                                <div
                                    ...
                                    <div class="mt-10 text-center mb-10">
                                        ...
                                        <div class="mt-6">
                                            <button type="button"
                                                onclick="window.location.href='/property/{{ Session::get('property_uuid') }}/unit/{{ $unit_details->uuid }}/bills'"
                                                class="inline-flex items-center rounded-md border border-transparent bg-purple-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
                    ...
                    <div class="hidden p-4 purple rounded-lg dark:bg-gray-800" id="collections" role="tabpanel"
