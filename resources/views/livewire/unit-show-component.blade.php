<?php
    $statusIcon = App\Models\Status::find($unit_details->status_id)->alt_icon;
                                            ...
                                            <div class="w-0 flex-1 pt-0.5">
                                                <div class="grid grid-cols-2">
                                                    ...
                                                    <p class="mt-1 text-sm font-base text-gray-500">
                                                        ...
                                                        $remittances->sum('marketing_fee') +
                                                        $remittances->sum('management_fee'),
                                                        2)}}
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex items-center px-8 py-5 border-b">
                                            <div class="w-0 flex-1 pt-0.5">
                                                ...
                                                <div class="grid grid-cols-2">
                                                    ...
                                                    <p class="flex-col mt-1 text-sm font-base text-gray-500">
                                                        {{
                                                        number_format($remittances->sum('materials_recovery_facility'),
                                                        2)}}
                                                    </p>
                                                    ...
                                                    <p class="flex-col mt-1 text-sm font-base text-gray-500">
                                                        {{
                                                        number_format($remittances->sum('recharge_of_fire_extinguisher'),
                                                        2)}}
                                                    </p>
