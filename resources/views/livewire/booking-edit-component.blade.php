        ...
        <div class="mt-8 lg:col-span-9">
           <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-8">
                                ...
                                {{-- <div class="sm:col-span-2">
                                    <div
                                        ...
                                        <select wire:model.debounce.500ms="status"
                                            class="block w-full border-0 p-0 text-gray-900 placeholder-gray-500 focus:ring-0 sm:text-sm">
                                            <option value="checked-in" {{ old('status', $status)=='checked-in' ? 'selected' : 'Select one' }}>
                                                checked-in
                                            </option>
                                            <option value="checked-out" {{ old('status', $status)=='checked-out' ? 'selected' : 'Select one' }}>
                                                checked-out
                                            </option>
                                            <option value="cancelled" {{ old('status', $status)=='cancelled' ? 'selected' : 'Select one' }}>
                                                cancelled
                                            </option>
                                            <option value="reserved" {{ old('status', $status)=='reserved' ? 'selected' : 'Select one' }}>
                                                reserved
                                            </option>
                                        </select>
                                        @error('status')
                                ...
                                <div class="sm:col-span-2">
                                    <div
                                        class="bg-white relative border border-gray-300 rounded-md rounded-t-none px-3 py-2 focus-within:z-10 focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                                        <label for="moveout_at" class="block text-xs font-medium text-gray-900">Departure Date</label>
                                ...
                                {{-- <div class="sm:col-span-4">
                                    <div
                                        class="bg-white relative border border-gray-300 rounded-md rounded-t-none px-3 py-2 focus-within:z-10 focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                                        <label for="vehicle_details" class="block text-xs font-medium text-gray-900">Vehicle Details</label>
                                ...
                                <div class="sm:col-span-4">
                                    <div
                                        class="bg-white relative border border-gray-300 rounded-md rounded-t-none px-3 py-2 focus-within:z-10 focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                                        <label for="plate_number" class="block text-xs font-medium text-gray-900">Plate Number</label>
                                ...
                                <div class="sm:col-span-8">
                                    <div
                                        class="bg-white relative border border-gray-300 rounded-md rounded-t-none px-3 py-2 focus-within:z-10 focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                                        <label for="special_request" class="block text-xs font-medium text-gray-900">Special Request</label>
                                ...
                                <div class="sm:col-span-8">
                                    <div
                                        class="bg-white relative border border-gray-300 rounded-md rounded-t-none px-3 py-2 focus-within:z-10 focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                                        <label for="flight_itinerary" class="block text-xs font-medium text-gray-900">Flight Itinerary</label>
                                ...
                                <div class="sm:col-span-2">
                                    <div
                                        class="bg-white relative border border-gray-300 rounded-md rounded-t-none px-3 py-2 focus-within:z-10 focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                                        <label for="no_of_person_with_disability" class="block text-xs font-medium text-gray-900">No of person with
                                            disability</label>
                            ...
                            <div class="mt-5 flex justify-end">
                                ...
                                &nbsp;
                                <button type="submit" wire:loading.remove wire:target="updateBooking"
                                    class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-purple-500 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Update
                                </button>
                                <button type="submit" disabled wire:loading wire:target="updateBooking"
                                    class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-purple-500 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Loading...
                                </button>
                            </div>
