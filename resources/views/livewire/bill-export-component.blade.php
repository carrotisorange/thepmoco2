        ...
        <form wire:submit.prevent="exportButton">
            <div class="mt-5 flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-full px-3">
                    ...
                    <x-form-input type="date" name="due_date" wire:model="due_date" />
            ...
            <div class="mt-5 flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-full px-3">
                    ...
                    <x-form-input wire:model="penalty" type="number" name="penalty" step="0.001" />
            ...
            <div class="mt-5 flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-full px-3">
                    ...
                    <x-form-textarea wire:model="note_to_bill" name="note_to_bill"></x-form-textarea>
