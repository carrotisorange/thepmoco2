<div>
    ...
    <div class="mt-5 space-x-5 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
        ...
        <div class="lg:col-span-1 mt-2 ml-5">
            ...
            <x-form-input wire:model="number_of_months_behind_dues" type="number" min="1" name="number_of_months_behind_dues" />
        ...
        <div class="lg:col-span-1 mt-2 ml-5">
            ...
            <x-form-select wire:model='is_proxy_voting_allowed' id="is_proxy_voting_allowed" name="is_proxy_voting_allowed">
