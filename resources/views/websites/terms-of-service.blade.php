...
<div class="relative overflow-hidden bg-white py-16">
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-prose text-lg">
            ...
            <p class="mt-8 text-xl leading-8 text-gray-500">Aliquet nec orci mattis amet quisque ullamcorper neque, nibh
        ...
        <div class="prose prose-lg prose-indigo mx-auto mt-6 text-gray-500">
            ...
            <p>Purus morbi dignissim senectus mattis <a href="#">adipiscing</a>. Amet, massa quam varius orci dapibus
                ...
                ridiculus non molestie. Gravida quis fringilla amet eget dui temppor dignissim. Facilisis auctor
