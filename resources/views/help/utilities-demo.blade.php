...
<div class="mt-8 bg-white min-h-screen">
    <h2 class="p-5 text-lg text-center"><span class="font-bold text-purple-700">How to Use the</span> Utilities Feature </h2>
...
<p class= "pt-5 text-center text-light text-sm">A demo video for using the utilities.<p class="text-center text-light text-sm"><span class="font-semibold text-purple-700">
