    ...
    <div class="max-full mx-auto sm:px-6">
        ...
        <div class="py-20 mt-0 sm:mt-0 lg:-mt-56  min-h-full  lg:gap-8 lg:px-8 bg-gray-600">
            ...
            <div class="flex justify-center items-center">
                <span class="max-w-md text-base font-light text-white">If you're looking for more information, or have questions about your account, please contact us below.</span>  
            </div>
        </div>
                                  ...
                                  <tbody class="">
                                        ...
                                        <tr class="relative transform scale-100
                                          ...
                                          <td class="px-2 py-5 whitespace-no-wrap">
                                              <a href="calendar-demo" class="leading-5 text-gray-900 text-base underline font-medium">How to Use the Booking Calendar
                                              </a>
        ...
        <div class="pb-10 mt-0 sm:mt-0 min-h-full lg:grid  lg:grid-cols-2 lg:gap-8 lg:px-8 bg-purple-100">
            ...
            <div class="">
              <div class="py-5 px-5  lg:px-0  lg:max-w-none  flex items-center justify-center">
                <img src="https://images.pexels.com/photos/6962998/pexels-photo-6962998.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" class="w-full">
              </div>
            </div>
            ...
            <div class="sm:pl-20 px-5 sm:px-20 md:px-20 lg:px-20 lg:py-10 sm:mt-0  lg:col-start-2">
              ...
              <div class="flex justify-center items-center">
                <p class="pb-10 text-2xl font-light text-gray-700">
                  Are you still <span class="font-bold text-purple-900">having trouble in using the system</span> and in need of <span class="font-bold text-purple-900">our assistance?</span>
                </p>
                
              </div>
              <p class="text-sm font-light">Unlike manual processes, we provide a full-suite solution that allows business owners to run their operations seamlessly and harmoniously with their tenants.</p>
              <div class="py-5 flex justify-center sm:justify-center items-center lg:justify-between">
                <button> <a href="https://thepropertymanager.online/about#contactus" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-medium text-white bg-purple-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Request a Demo</a></button>
