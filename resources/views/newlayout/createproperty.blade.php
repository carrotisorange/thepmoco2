...
-->
  <html class="h-full w-full bg-no-repeat bg-cover"
        style= "background-image: url('/brands/createprop.png');">
  ...
  <header class="relative flex h-16 flex-shrink-0 items-center bg-white ">
    ...
    <div class="absolute inset-y-0 left-0 md:static md:flex-shrink-0">
      <a href="#" class="flex h-16 w-16 items-center justify-center  bg-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gray-600 md:w-20">
        <img class="ml-5 h-15 w-auto"src="{{ asset('/brands/logo_text.png') }}">
      </a>
    </div>
...
<form class="space-y-8">
    ...
    <div class="pt-10">
      ...
      <div class="sm:col-span-6">
          ...
          <div class="mt-5">
            <input type="text" name="street-address" id="street-address" autocomplete="street-address" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block h-8 w-full sm:text-sm border-gray-300 rounded-md">
          </div>
        </div>
         ...
         <div class="sm:col-span-2">
          ...
          <div class="mt-5">
            <input type="text" name="city" id="city" autocomplete="address-level2" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block h-8 w-full sm:text-sm border-gray-300 rounded-md">
          </div>
        </div>
        ...
        <div class="sm:col-span-2">
          ...
          <div class="mt-5">
            <input type="text" name="region" id="region" autocomplete="address-level1" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block h-8 w-full sm:text-sm border-gray-300 rounded-md">
          </div>
        </div>
        ...
        <div class="sm:col-span-2">
          ...
          <div class="mt-5">
            <input type="text" name="postal-code" id="postal-code" autocomplete="postal-code" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block h-8 w-full sm:text-sm border-gray-300 rounded-md">
          </div>
        </div>
        ...
        <div class="sm:col-span-4">
          ...
          <div class="mt-5">
            <select id="property" name="property" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block h-8 w-full sm:text-sm border-gray-300 rounded-md">
    ...
    <label for="unitsNumber" class="block text-sm font-medium text-gray-700">Number of Units</label>
    <div class="mt-5">
    <input type="number" class=" form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700bg-white bg-clip-padding border border-solid border-gray-300 rounded-md transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
      id="unitsNumber"
      placeholder=""/>
  </div>
</div>
...
<div class="sm:col-span-1">
    <label for="unitsNumber" class="block text-sm font-medium text-gray-700">Number of Employees</label>
    <div class="mt-5">
    <input type="number" class=" form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700bg-white bg-clip-padding border border-solid border-gray-300 rounded-md transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
      id="unitsNumber"
      placeholder=""/>
  ...
  <div class="pt-5">
    <div class="flex justify-end">
      ...
      <button type="submit" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-purple-500 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Create</button>
    </div>
  </div>
</form>
