...
<div class="mt-10 px-4 sm:px-6 lg:px-8">
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-3xl font-bold text-gray-700">Tenant/Owner Name</h1>
      <h3 class="text-xl font-semibold text-gray-500">Reference #:</h3>
    </div>
      ...
      <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
        <div>
          ...
          <div class="mt-3 text-center sm:mt-5">
            <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Bill Information</h3>
            
            <div class="mt-3 sm:col-span-3">
            <h3 class="text-left text-sm font-medium leading-6 text-gray-900" id="modal-title">Bill Information</h3>
          <label for="concern" class="block text-sm font-medium text-gray-700"></label>
            ...
            <select id="concern" name="concern" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block h-8 w-full sm:text-sm border border-gray-700  rounded-md">
              ...
              <option>Utilities Deposit</option>
              <option>Water</option>
        ...
        <div class="mt-3 sm:col-span-3">
            <h3 class="text-left text-sm font-medium leading-6 text-gray-900" id="modal-title">Unit</h3>
          <label for="concern" class="block text-sm font-medium text-gray-700"></label>
          
          <input type="text" class="w-full border border-gray-500 rounded-md"></td>
  
        </div>

        <div class="mt-3 sm:col-span-3">
            <h3 class="text-left text-sm font-medium leading-6 text-gray-900" id="modal-title">Period Covered</h3>
          <label for="concern" class="block text-sm font-medium text-gray-700"></label>
        ...
        <div class="mt-3 sm:col-span-3">
            <h3 class="text-left text-sm font-medium leading-6 text-gray-900" id="modal-title">Amount</h3>
          <label for="concern" class="block text-sm font-medium text-gray-700"></label>
        ...
        <div class="mt-3 sm:col-span-3">
        <input id="filter-mobile-category-0" name="category[]" value="tees" type="checkbox" class="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                  <label for="filter-mobile-category-0" class="ml-2 text-sm text-gray-500">Send bill to email.</label>
                  </div>
        ...
        <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
          <button type="button" class="inline-flex w-full justify-center rounded-md border border-transparent bg-purple-700 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:col-start-2 sm:text-sm">Create</button>
