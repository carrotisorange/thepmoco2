...
-->
  ...
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-xl font-semibold text-gray-700 mt-5">Payment Approval</h1>
  ...
  <div class="flex justify-center mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
    ...
    <div class="mt-5 md:mt-0 md:col-span-6">
      <form action="#" method="POST">
        ...
        <div class="sm:col-span-6">
              <label for="concern" class="block text-sm font-medium text-gray-700">Proof of payment</label>
              <div class="mt-1">
        ...
        <fieldset>
        <div>
          <label for="about" class="block text-sm font-medium text-gray-700">Approved by:
          </label>
          <div class="mt-1">
