...
-->
              ...
              <div class="relative flex w-20 flex-col space-y-1 p-3">
                ...
                <a href="newtenant" class="ml-2 text-gray-400 hover:bg-gray-100 flex-shrink-0 inline-flex items-center justify-center h-10 w-10 rounded-lg">
                  <span class="sr-only">Concerns</span>
                    ...
                    <!-- Concerns -->
                <a href="newconcern_list" class="ml-2 bg-purple-500 text-white flex-shrink-0 inline-flex items-center justify-center h-10 w-10 rounded-lg">
                  <span class="sr-only">Concerns</span>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
          ...
          <h1 class="mt-2 text-4xl font-bold tracking-tight text-gray-800 sm:text-4xl">Concern Feature Locked</h1>
          <p class="mt-2 text-base text-purple-500">Unlock this feature for only <span class="font-bold text-xl">₱300/month!</span></p>
          <p class="mt-3 text-sm max-w-lg text-gray-600">Tenant concerns are usually about billing, payments, contracts, house rules, or maintenance concerns. Billing, payments, and contract concerns are reduced through the <a href="receivable-bills-lock" class="font-semibold text-purple-700">Billing and Payment Management</a>  Feature or <a href="contract-lock" class="font-semibold text-purple-700">Contract Management</a> Feature.</p>
          <p class="mt-3 text-sm max-w-lg text-gray-600">As Landlords and property managers, we prefer to know our tenants concerns first so we can manage them before they use social media or other public portals to voice out their concerns. Great customer service is anticipating concerns and having a ready solution. Responding immediately to concerns is also a measure of great customer service. 
</p>
          ...
          tenant and owners can upload picture of their concerns</li>
          ...
          landlord & management receives the concern in the dashbboard and respond</li>
          ...
          can use as stand alone feature or together with the <a href="tenant-portal-lock" class="font-bold text-purple-700">TENANT PORTAL</a> for optimal end to end concern solution </li>
  ...
  <img class="h-full w-full" src="{{ asset('/brands/unlock/concern-sample.png') }}" alt="contracts feature">
  </div>
</div>
</div>
