...
<main class="flex-1 pb-8 h-screen y-screen overflow-y-scroll">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
          ...
          <h1 class="mt-2 text-4xl font-bold tracking-tight text-gray-800 sm:text-4xl">Tenant Portal Feature Locked</h1>
          <p class="mt-2 text-base text-purple-500">Unlock this feature for only <span class="font-bold text-xl">₱600/month!</span></p>
          
          <p class="mt-5 text-sm max-w-lg text-gray-600">Great customer experience is possible through tech enabled experiences. Reduce face to face contact and still build that rapport with your tenant is possible with a tenant portal. In this digital age, technology enablement is vital for a harmonious experience between tenants and rental business. This will form part of your competitive advangate over other landlords.
</p>
          ...
          allows tenant to view their bills, payment history</li>

          <li class=" mb-2">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-green-800 w-5 h-5 inline-block">
          <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>  
          allows tenant to upload proof of payment for rent and other bills</li>

          <li class=" mb-2">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-green-800 w-5 h-5 inline-block">
          <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>  
          allows tenant to view contracts and request for moveout </li>
          
          <li class=" mb-2">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-green-800 w-5 h-5 inline-block">
          <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>  
          allows tenant to send concerns </li>
          ...
          works well with <a href="concern-lock" class="font-bold text-purple-700">CONCERNS MANAGEMENT</a> and <a href="receivable-bills-lock" class="font-bold text-purple-700">BILLS AND PAYMENT MANAGEMENT</a> </li>
  ...
  <img class=" h-full w-full pr-10" src="{{ asset('/brands/unlock/tenant-sample.png') }}" alt="contracts feature">
  </div>
</div>
</div>
