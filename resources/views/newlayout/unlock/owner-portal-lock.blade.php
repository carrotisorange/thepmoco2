...
-->
          ...
          <div class="max-w-8xl mx-auto flex items-center px-4 sm:px-6">
            <div class="flex-shrink-0">
              ...
              <div class="ml-3 min-w-0 flex-1">
                <div class="truncate text-base font-medium text-gray-800">Maria</div>
                  <div class="truncate text-sm font-medium text-gray-500">Maria_tenant@gmail.com</div>
              </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
          ...
          <h1 class="mt-2 text-4xl font-bold tracking-tight text-gray-800 sm:text-4xl">Owner Portal Feature Locked</h1>
          <p class="mt-2 text-base text-purple-500">Unlock this feature for only <span class="font-bold text-xl">₱600/month!</span></p>
          <p class="mt-5 text-sm max-w-lg text-gray-600">Real Estate Investors in Rental Properties believe that real estate is the best investment not only because of the excellent return on their investment but because it is tangible qualities. However, not all real estate investors want the work of managing their rental property. They prefer to hire the services of a professional leasing and property manager to oversee the day to day operations of the rental property. For professional leasing and property managers, it is part of our responsibility to report to the owner all the transactions pertaining to their property no matter. </p>
          ...
          gives viewing access to the property owner to view property status, transactions, payments, maintenance or repairs to be done</li>
          ...
          gives owner approval for repair and maintenance works</li>
          ...
          no need to create and send regular reports, just give owner portal access to owners</li>
          ...
          works optimally with <a href="concern-lock" class="font-bold text-purple-700">CONCERNS MANAGEMENT</a> and <a href="receivable-bills-lock" class="font-bold text-purple-700">BILLING AND COLLECTION</a> features.</li>
