...
<div class="flex h-full flex-col">
  ...
  <header class="relative flex h-16 flex-shrink-0 items-center bg-white">
    ...
    <!-- Main area -->
    <main class="bg-white flex-1 pb-8 h-screen y-screen overflow-y-auto">
...
-->
  ...
  <h2 class="pt-3 pb-5 text-center text-4xl font-bold tracking-tight text-gray-900 font-pop">Oops!</h2>
  ...
  <img class="h-56 w-auto"src="{{ asset('/brands/unlock/oops.png') }}">
    ...
    <p class="text-center font-semibold text-lg text-gray-700">Looks like you don't have access to <span class="font-bold text-purple-900">[this]</span> feature.</p>
    <p class="mt-2 text-center  font-light text-medium text-gray-700">Unlock now for easier management!</p>
    <div class="mt-5 flex items-center justify-center">
    <div button type="button" class="mr-3 w-32 items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full shadow-sm text-white text-center bg-purple-900 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"><a href="check-page">Unlock now.</a></button></div>

<div button type="button" class="w-32 items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full shadow-sm text-white text-center bg-gray-900 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">No thanks.</button></div>
</div>
