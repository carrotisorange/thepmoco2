...
-->
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
          ...
          <h1 class="mt-2 text-4xl font-bold tracking-tight text-gray-800 sm:text-3xl">Account Payable Feature Locked</h1>
          <p class="mt-2 text-base text-purple-500">Unlock this feature for only <span class="font-bold text-xl">₱300/month!</span></p>
          <p class="mt-3 text-sm max-w-lg text-gray-600">Recording monthly payments of utilities, salaries & wages, other operating expenses is best practice for rental properties. Keeping track that operating expenses do not go beyond budget. Graphing operating expenses will show fluctuations in operations. </p>
          ...
          request for purchases and payments go through approval flow before cash is released for payment.</li>
          ...
          not only for record keeping but to implement account payable policies and approval flows.</li>
          ...
          use together with <a href="receivable-bills-lock" class="font-bold text-purple-900">ACCOUNTS RECEIVABLE MANAGEMENT</a> for complete reports in <a href="cashflow-lock" class="font-bold text-purple-900">CASHFLOW</a> from operating activities. </li>
  ...
  <img class="mt-20 h-80 w-fit" src="{{ asset('/brands/unlock/accounts.png') }}" alt="contracts feature">
  </div>
</div>
</div>
