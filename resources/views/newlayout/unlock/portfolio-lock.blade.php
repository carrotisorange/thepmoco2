...
-->
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
          ...
          <h1 class="mt-2 text-4xl font-bold tracking-tight text-gray-800 sm:text-4xl">Portfolio Feature Locked</h1>
          <p class="mt-2 text-base text-purple-500">Unlock this feature for only <span class="font-bold text-xl">₱600/month!</span></p>
          <p class="mt-5 text-sm max-w-lg text-gray-600">A portfolio property manager has multiple properties under its management. Real time performance of the properties managed is crucial in property analysis and in projecting future cash flows and operating expenses. A comparative view of all properties helps top management helps in strategic investment decision making. Generating reports of the properties is very easy with this Portfolio Dashboard.  </p>
          ...
          side by side comparative view of all properties</li>
          ...
          see all rental property performance metrics for easier and real time monitoring</li>
          ...
          available for 2 or more properties managed</li>
          ...
          optimal use with <a href="receivable-bills-lock" class="font-bold text-purple-700">BILLING AND COLLECTION</a> and <a href="payable-lock" class="font-bold text-purple-700">PAYABLES</a> Feature.</li>
