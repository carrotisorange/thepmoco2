...
-->
  ...
  <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
    ...
    <div class="mt-5 grid grid-cols-3 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">

    <div class="col-start-1 mt-4 sm:mt-0 flex  gap-x-3 mb-10 lg:w-full sm:w-10 ">
    <div class="relative text-gray-600">
  <input type="search" name="serch" placeholder="Search" class=" bg-white border border-gray-200 h-10 px-5 pr-10 rounded-full text-sm focus:outline-none">
  <button type="submit" class="absolute right-0 top-0 mt-3 mr-4">
    ...
    <div class="col-start-3 mt-4 sm:mt-0 flex  gap-x-3 mb-10 ">
      <button type="button" class="inline-flex items-center justify-center rounded-md border border-transparent bg-gray-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">Add Property</button>
      <button type="button" class="inline-flex items-center justify-center rounded-md border border-transparent bg-purple-900 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto"><a href="portfolio-lock">Portfolio Dashboard</a></button>
</div>
  ...
  <div class="mt-5 hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
    ...
    <div>
      <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
        ...
        <div class="mt-1 mb-5 grid grid-cols-2 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
            <div class="group relative">
                <div class="w-full h-32 bg-white rounded-md overflow-hidden group-hover:opacity-75 lg:h-72 lg:aspect-none flex items-center justify-center">
                    <img src="{{ asset('/brands/property_page.png') }}" alt="building" class="w-40 object-center object-cover lg:w-full lg:h-full">    
                </div>
                <h3 class="text-medium text-gray-700 font-semibold justify-center text-center">ABCD Property</h3>
            </div>
