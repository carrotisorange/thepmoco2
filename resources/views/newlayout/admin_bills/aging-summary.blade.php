...
<div class="mt-10 px-4 sm:px-6 lg:px-8">
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      ...
      <p class="font-semibold">Aging Summary</p>
    </div>
    ...
    <button type="button" class="inline-flex items-center justify-center rounded-md border border-transparent bg-green-900 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto"><a href="paybills">Pay Bills</a></button>
...
<form>   
    ...
    <div class="-my-2 -mx-4 overflow-x-auto lg:px-36 sm:-mx-6 lg:-mx-8 lg:max-w-7xl ">
