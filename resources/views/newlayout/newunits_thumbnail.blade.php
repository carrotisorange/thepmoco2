    ...
    <!-- Mobile menu, show/hide this `div` based on menu open/closed state -->
      ...
      -->
        ...
        <div class="max-w-8xl mx-auto py-3 px-2 sm:px-4">
            ...
            <a href="#" class="block rounded-md py-2 pl-5 pr-3 text-base font-medium text-gray-500 hover:bg-gray-100">Team</a>
...
<div class="mt-10 px-4 sm:px-6 lg:px-8">
  <div class="sm:flex sm:items-center">
    ...
    <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
      <button type="button" class="inline-flex items-center justify-center rounded-md border border-transparent bg-purple-900 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">View as List</button>
    </div>
  </div>
...
<form>   
    ...
    <div class="relative w-full mb-5">
        ...
        <button type="button" class="text-center bg-white block p-1 w-full text-sm h-8 text-gray-900 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white ">Filter by Default</button>
</div>
    </div>
</form>
...
-->
  ...
  <div class="max-w-2xl mx-auto py-8 px-4  sm:px-6 lg:max-w-7xl lg:px-8">
    <div class="flex items-center justify-between space-x-4">
      <h2 class="text-lg font-medium text-gray-900">Ground Floor</h2>

    </div>
    <div class="mt-6 grid grid-cols-1 gap-x-8 gap-y-8 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-6">

          <div>
          <img src="{{ asset('/brands/close_occupied.png') }}" class="object-center object-cover aspect-w-4 aspect-h-3 rounded-lg overflow-hidden">
          <h3 class="text-center mt-2">Unit 1</h3>
          </div>

          <div class="transform hover:background-image: url('/brands/occupied.png');">
          <img src="{{ asset('/brands/close_occupied.png') }}" class="object-center object-cover aspect-w-4 aspect-h-3 rounded-lg overflow-hidden">
          <h3 class="text-center mt-2">Unit 1</h3>
          </div>
