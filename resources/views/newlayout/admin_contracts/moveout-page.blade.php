...
-->
  ...
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-xl font-semibold text-gray-700 mt-5">Moveout</h1>
    ...
    <div class="mt-5 md:mt-0 md:col-span-6">
      <form action="#" method="POST">
        ...
        <div class="sm:col-span-6">
              <label for="concern" class="block text-sm font-medium text-gray-700">Reason for moveout:</label>
              <div class="mt-1">
        ...
        <div>
          ...
          <div class="px-4 py-3 text-right sm:px-6">
            <button type="submit" class="inline-flex justify-end py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Moveout</button>
          </div>
        </div>
      </form>
    </div>
