...
<div class="mt-8 max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8">
  <div class="lg:grid lg:grid-cols-12 lg:auto-rows-min lg:gap-x-8">
    ...
    <div class="mt-8 lg:mt-0 lg:col-start-1 lg:col-span-4  lg:row-span-3">
      ...
      <h1 class="text-center">username: juandelacruz</h1>
      ...
      <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
        <div>
          ...
          <div class="mt-3 text-center sm:mt-5">
            <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Change Username</h3>
        ...
        <div class="mt-3 sm:col-span-3">
            <h3 class="text-left text-sm font-medium leading-6 text-gray-900" id="modal-title">Old Username</h3>
        ...
        <div class="mt-3 sm:col-span-3">
            <h3 class="text-left text-sm font-medium leading-6 text-gray-900" id="modal-title">New Username</h3>
          <label for="concern" class="block text-sm font-medium text-gray-700"></label>
        ...
        <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
          <button type="button" class="inline-flex w-full justify-center rounded-md border border-transparent bg-purple-700 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:col-start-2 sm:text-sm">Change</button>
