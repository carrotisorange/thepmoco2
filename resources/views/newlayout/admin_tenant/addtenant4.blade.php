...
<form class="space-y-6" action="#" method="POST">
  ...
  <div class="bg-gray-100 mt-5 px-4 py-5 sm:rounded-lg sm:p-6">
      ...
      <div class="mt-5 md:mt-0 md:col-span-2">
        <div class="grid grid-cols-2 gap-6">
          <div class="col-span-1">
            <label for="first-name" class="block text-sm font-medium text-gray-700">Start</label>
          ...
          <div class="col-span-1">
            <label for="last-name" class="block text-sm font-medium text-gray-700">End</label>
          ...
          <div class="col-span-1">
            <label for="email-address" class="block text-sm font-medium text-gray-700">Rent</label>
          ...
          <div class="col-span-1">
            <label for="email-address" class="block text-sm font-medium text-gray-700">Interaction</label>
            <input type="text" name="email-address" id="email-address" autocomplete="email" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border border-gray-700 rounded-md">
          </div>
          ...
          <input id="filter-mobile-category-0" name="category[]" value="tees" type="checkbox" class="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                  <label for="filter-mobile-category-0" class="ml-3 text-sm text-gray-500">Send contract to email.</label>
          </div>
    ...
    <button type="button" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"><a href="addtenant3">Back</a></button>
    <button type="submit" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-purple-500 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"><a href="addtenant5">Next</a></button>
  </div>
  </div>
