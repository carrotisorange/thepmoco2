...
<html class="h-full w-full bg-no-repeat bg-cover"
        style= "background-image: url('/brands/success_bg.png');">
...
-->
  ...
  <h2 class="p-10 text-center text-3xl font-bold tracking-tight text-gray-900 font-pop">You've successfully created Property Name!</h2>
  <div class=" flex items-center justify-center">
  <img class="h-48 w-auto"src="{{ asset('/brands/success_property.png') }}">
    </div>

    <div class=" mt-10 flex items-center justify-center">
    <div button type="button" class="w-64 items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full shadow-sm text-white text-center bg-gray-900 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Let's get started.</button></div>
</div>
