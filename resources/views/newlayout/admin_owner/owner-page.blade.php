          ...
          <table class="min-w-full table-fixed">
            ...
            <tbody class=" divide-gray-50 border divide-y gap-y-6 bg-white">
              ...
              <tr>
                ...
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"> <a href="newownerprofile" class="text-purple-700">Maria Clara</a></td>
