...
<div class="lg:-ml-24 sm:ml-0 col-start-1 col-span-2">

      <div class="flex items-center justify-center mr-5">
      <img src="{{ asset('/brands/user.png') }}" alt="door" class="h-48  rounded-md">
      </div>

      <p class="mt-5 font-bold text-lg text-center sm:text-gray-900 lg:text-white">
        Maria Clara
      </p>
      

      <div class="flex items-center justify-center">
      <a href="change-username" class="mt-8 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">Change Username / Password</a>
      </div>

     

      <div class="flex items-center justify-center">
      <a href="change-password" class="mt-5 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">Generate Credentials</a>
      </div>
...
<div class="max-w-2xl mx-auto">
    ...
    <div id="myTabContent">
        ...
        <button type="button" class="inline-flex items-center px-3.5 py-2 border border-transparent text-sm leading-4 font-medium rounded-full shadow-sm text-white bg-indigo-400 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Edit</button>
        </div> 
          <p class="font-medium text-xl text-gray-900">Owner Information</p>
          </div>
        ...
        <div class="sm:col-span-4">
          ...
          <div class="sm:col-span-4">
          <div class="bg-white relative border border-gray-300 rounded-md rounded-t-none px-3 py-2 focus-within:z-10 focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
            <label for="job-title" class="block text-xs font-medium text-gray-900">Spouse</label>
              <input type="text" name="job-title" id="job-title" class="block w-full border-0 p-0 text-gray-900 placeholder-gray-500 focus:ring-0 sm:text-sm" placeholder="">
          </div>
          </div> 
          ...
          <div class="sm:col-span-2">
          <div class="bg-white relative border border-gray-300 rounded-md rounded-t-none px-3 py-2 focus-within:z-10 focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
            <label for="job-title" class="block text-xs font-medium text-gray-900">Bank</label>
              <input type="text" name="job-title" id="job-title" class="block w-full border-0 p-0 text-gray-900 placeholder-gray-500 focus:ring-0 sm:text-sm" placeholder="">
          </div>
          </div>
          ...
          <div class="sm:col-span-2">
          <div class="bg-white relative border border-gray-300 rounded-md rounded-t-none px-3 py-2 focus-within:z-10 focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
            <label for="job-title" class="block text-xs font-medium text-gray-900">Number</label>
              <input type="text" name="job-title" id="job-title" class="block w-full border-0 p-0 text-gray-900 placeholder-gray-500 focus:ring-0 sm:text-sm" placeholder="">
          </div>
          </div>
        ...
        <h1 class="text-gray-900 font-bold lg:text-lg sm:text-sm sm:text-center">18%</h1>
        </div>
       </div>
       ...
       <table class="min-w-full table-fixed">
        ...
        <div class="grid gap-y-3 gap-x-4 sm:grid grid-cols-1 lg:grid-cols-4 mt-2">
        <div class="col-span-3">
        <h1 class="lg:mx-10 sm:mx-0 mb-5 font-medium text-xl text-gray-900 ">Collection History</h1>
        </div>
       ...
       <table class=" min-w-full ">
            ...
            <thead class="bg-white divide-gray-50 border ">
              <tr>
                ...
                <th scope="col" class="min-w-[12rem] py-3.5 pr-3text-left text-sm font-semibold text-gray-900">#</th>
                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">TENANT</th>
                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">UNIT</th>
                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">DATE</th>
                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">AMOUNT PAID</th>
       ...
       <table class="min-w-full table-fixed">
            ...
            <tbody class=" divide-gray-50 border divide-y gap-y-6 bg-white">
              ...
              <tr>
                ...
                <!-- Selected: "text-indigo-600", Not Selected: "text-gray-900" -->
                <td class="whitespace-nowrap px-3 py-4 text-sm font-medium text-gray-900">1</td>
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">August 1</td>
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">Water</td>
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">10,000.00</td>
                <td class="whitespace-nowrap px-3 py-4 text-sm  text-gray-500">0.00</td>
        ...
        <div class="mx-10 grid grid-cols-1 gap-y-3 gap-x-4 sm:grid-cols-8 mt-2">
