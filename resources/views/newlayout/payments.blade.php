...
<div class="mt-10 px-4 sm:px-6 lg:px-8">
  ...
  <div class="mt-5 flex flex-col-2">
  <form>   
    ...
    <div class="relative w-64 mb-5">
        ...
        <input type="search" id="default-search" class="block p-4 pl-10 w-full text-sm h-5 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." required>
        
    </div>
</form>
<form>   
    <label for="default-search" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-gray-300">Filters</label>
    <div class="ml-8 relative w-64 mb-5">
        <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
        ...
        <button type="button" class="block p-1 w-full text-sm h-8 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white ">Filter</button>
    ...
    <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
      ...
      <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
        ...
        <div class="mb-5 relative overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
          ...
          <table class="min-w-full table-fixed divide-y-8 divide-gray-50 border">
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              ...
              <tr>
                ...
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">E-wallet</td>
