...
<div class="mx-10 m-5 grid sm:grid-cols-2 gap-x-4 lg:grid-cols-6">
...
<div class="my-5 relative">
      ...
      <div class="lg:ml-6 md:ml-5 sm:ml-1 max-w-3xl sm:px-6 sm:mx-3 lg:mx-5 lg:px-5">
        <div class="relative shadow-md sm:overflow-hidden sm:rounded-2xl">
          <div class="absolute inset-0">
            <img class="h-full w-full object-cover" src="{{ asset('/brands/dash1.png') }}">
            
          </div>
          <div class="relative px-4 py-10 sm:px-6 sm:py-20 lg:py-10 lg:px-8">
            <h1 class="text-left text-xl font-bold tracking-tight sm:text-xl lg:text-3xl">
            ...
            <div class="mt-2 w-full bg-gray-200 rounded-full dark:bg-gray-700">
              <a href="tenant-page">
    <div class="bg-indigo-400 text-xs font-medium text-white text-center p-0.5 leading-none rounded-full" style="width: 56%"> 56%</div></a>
  </div>
            </div>
        </div>
      </div>
...
<div class="">
    ...
    <div class="ml-auto mr-auto px-12 mt-10 grid grid-cols-2 gap-y-5 gap-x-6 sm:mt-10 sm:grid-cols-1 lg:grid-cols-6 lg:gap-x-5">

    <div class="col-span-1">
      <div class="bg-purple-300 h-full overflow-hidden rounded-lg shadow-md rounded-5xl mb-5">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941" />
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="text-4xl font-bold text-white mr-2">56.9K</div>
      ...
      <div class="col-span-1">
      <div class="bg-indigo-200 h-full overflow-hidden rounded-lg shadow-md rounded-5xl mb-5">
        <div class="flex items-center px-5 py-3">
                        <div class="mr-5">
                            <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-purple-900 w-8 h-8">
  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6L9 12.75l4.286-4.286a11.948 11.948 0 014.306 6.43l.776 2.898m0 0l3.182-5.511m-3.182 5.51l-5.511-3.181" />
      ...
      <div class="col-span-1">
      <div class="bg-purple-100  h-full overflow-hidden rounded-lg shadow-md rounded-5xl mb-5">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
      ...
      <div class="col-span-1">
      <div class="lg:w-36 sm:w-full bg-gray-100 h-full overflow-hidden rounded-lg shadow-md rounded-5xl mb-5">
        <div class="flex items-center px-5 py-7">
                        <div class="mr-5">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-purple-900 w-6 h-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M22 10.5h-6m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z" />
    ...
    <div class="lg:-my-56 sm:my-2 lg:mx-6 sm:mx-2 w-full col-span-2">

<!-- calendar -->
<div  class='flex justify-center items-center mb-8  bg-white shadow-md rounded-lg p-1 max-w-full '>
      ...
      <div class="bg-white lg:flex-0 sm:items-center mb-5 lg:h-72 sm:h-48 md:h-80  overflow-hidden rounded-lg shadow-md rounded-5xl">
...
<div class="mt-10 sm:my-10 mr-6 col-span-2">




<div class=" bg-white rounded-lg shadow-md p-5 h-full w-full">
...
<div class="col-span-1">
  <div class="h-5 w-full overflow-hidden">
    <div class="flex items-center ">
                    <div class="">
                        <div class="ml-2 flex items-center">
                            <span class="animate-pulse mx-1 text-red-600">2</span>
...
<div class="mt-10 col-span-2">
	...
	<!-- Component Start -->
    <div class="items-center w-full h-full lg:p-12 bg-white rounded-lg shadow-md sm:p-10">
...
<div class="mt-10 mx-5 col-span-2">
  ...
  <div class="bg-white h-full rounded-lg shadow-md overflow-hidden">
        ...
        <div class="bg-white mt-10 mr-5 pt-12 px-5 rounded-lg shadow-lg lg:my-10 sm:my-20 pb-5 col-span-4">
