...
<div class="relative flex min-h-10 ">
...
<div class="my-5  sm:block lg:block">
      
      <div class="md:ml-5 sm:ml-1 sm:px-6 sm:mx-3  lg:px-5">
        <div class="col-span-3  sm:rounded-2xl">
...
<div class="sm:my-5 mx-10 sm:block">
<div class=" bg-white rounded-lg max-w-sm shadow-md p-5 h-72 ">
