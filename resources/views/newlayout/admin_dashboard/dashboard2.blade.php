...
<div class="mx-3 m-5 sm:grid grid-cols-1 gap-x-4 lg:grid-cols-6">

<div class="col-span-2 sm:block ">
      
      <div class=" md:ml-5 sm:ml-1 ">
        <div class="">
          <div class="absolute inset-0">
            
            
          </div>
          <div class="relative py-10 sm:py-20 lg:py-0 lg:">
  ...
  <div class="">
    <div class="flex justify-end items-end pr-5 pt-6">
                ...
                <div class="flex items-center">
                  ...
                  <div class="pl-7 text-xl font-semibold text-black ">Requests</div>
...
<div class="container flex  w-full items-center justify-center">
 ...
 <ul class="flex flex-col p-4">
      <li class="border-gray-400 flex flex-row mb-2">
        <div class="select-none cursor-pointer bg-gray-100 rounded-md flex flex-1 items-center p-4  transition duration-500 ease-in-out transform hover:-translate-y-1 hover:shadow-lg">
          <div class="flex flex-col rounded-md w-10 h-10 bg-gray-100 justify-center items-center mr-4">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-indigo-500 w-6 h-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
          ...
          <div class="flex-1 pl-1 mr-16">
            ...
            <div class="text-gray-600 text-sm">Tenant 1 wants to pay</div>
          </div>
          <div class="text-gray-600 text-xs">View</div>
        </div>
      </li>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
          ...
          <div class="flex-1 pl-1 mr-16">
            <div class="font-medium">Moveout Request </div>
            <div class="text-gray-600 text-sm">Tenant 1 wants to moveout</div>
          </div>
          <div class="text-gray-600 text-xs">View</div>
        </div>
      </li>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
          ...
          <div class="flex-1 pl-1 mr-16">
            <div class="font-medium">Request for Payment</div>
            <div class="text-gray-600 text-sm">Employee wants approval</div>
          </div>
          <div class="text-gray-600 text-xs">View</div>
        </div>
      </li>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
          ...
          <div class="flex-1 pl-1 mr-16">
            <div class="font-medium">Concerns</div>
            <div class="text-gray-600 text-sm">Tenant 1 has concern</div>
          </div>
          <div class="text-gray-600 text-xs">View</div>
        </div>
      </li>
...
<!--notifications -->
    <div class="lg: sm:my-10  col-span-2">
  <div class="bg-indigo-200 rounded-lg shadow-md w-80">
    <div class="flex justify-end items-end pr-5 pt-6">
...
<div class="flex">
                          <div class="ml-10 cols-span-1">
                          <div class="bg-gray-50 h-20 w-32 overflow-hidden shadow rounded-lg mb-10">
                      ...
                      <div class="ml-10 cols-span-1">
                        ...
                        <div class="cols-span-1">
                          <div class="bg-gray-50 h-20 w-32 overflow-hidden shadow rounded-lg mb-10">
                            <div class="ml-2 mt-2 text-sm font-semibold font-body text-gray-500 truncate">Maintenance:</div>
                            <div class="text-center font-semibold font-body text-gray-500 truncate"><a href=newconcern_list class="text-gray-700 text-3xl ">50</a> </div>
                        </div>
                      </div>
                      </div>
...
<div class="col-span-3 mx-20">
              ...
              <div class="-mt-10 ml-8 cols-span-1">
                          <div class="bg-gray-50 h-20 w-32 overflow-hidden shadow rounded-lg mb-10">
              ...
              <div class="-mt-10 cols-span-1">
                          <div class="bg-gray-50 h-20 w-32 overflow-hidden shadow rounded-lg mb-10">
                            <div class="ml-2 mt-2 text-sm font-semibold font-body text-gray-500 truncate">Active Tenants:</div>
                            <div class="text-center font-semibold font-body text-gray-500 truncate"><a href=newconcern_list class="text-gray-700 text-3xl ">50</a> </div>
                          </div>
              </div>
</div>
