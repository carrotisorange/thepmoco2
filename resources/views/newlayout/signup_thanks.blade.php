...
<!--
  ...
  ```
-->
<html class="h-full w-full bg-no-repeat bg-gray-50">
...
<div class="flex h-full flex-col">
  ...
  <header class="relative flex h-16 flex-shrink-0 items-center bg-white">
    ...
    <!-- Main area -->
    <main class="flex-1 pb-8 h-screen y-screen overflow-y-auto">
...
-->
  ...
  <h2 class="pt-3 pb-5 text-center text-2xl font-bold tracking-tight text-gray-900 font-pop">Thanks for signing up!</h2>
  <p class="text-center text-md font-medium text-medium text-gray-700">Your journey with The Property Manager Online starts when you</p>
  <p class="text-center text-md font-medium text-medium text-gray-700">verify your email by clicking the link we sent you.</p>
  </p>
  <p class="mt-5 text-center text-md font-normal text-gray-500">If you did not receive an email, click on the resend button below.</p>
  

    <div class="mt-5 flex items-center justify-center">
    <div button type="button" class="mr-3 w-56 items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full shadow-sm text-white text-center bg-purple-900 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Resend verification email</button></div>
</div>

<div class="mt-3 flex items-center justify-center">
<div button type="button" class="w-32 items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full shadow-sm text-white text-center bg-gray-900 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Log Out</button></div>
</div>
</div>
