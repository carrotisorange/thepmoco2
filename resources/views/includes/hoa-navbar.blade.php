<nav aria-label="Sidebar" class="hidden md:block md:flex-shrink-0 md:bg-white overflow-auto h-screen pb-32">
    <div class="relative flex w-22 flex-col space-y-3 p-3">
        ...
        <x-nav-link href="/property/{{ Session::get('property_uuid') }}/unit" :active="request()->routeIs('unit')">
            <span class="sr-only">Community Bulletin</span>
            <img class="h-7 w-auto" src="{{ asset('/brands/community-bulletin.png') }}" fill="none" viewBox="0 0 24 24"
        ...
        <div class="font-medium leading-3 -ml-2 text-xs text-center text-gray-900 mt-10">Community <br>Bulletin</div>
        ...
        <!-- Election -->
        @if(Session::get('property_uuid'))
        <x-nav-link href="/property/{{ Session::get('property_uuid') }}/election"
            :active="request()->routeIs('election')">

            <span class="sr-only">Election</span>
            <img class="h-8 w-auto" src="{{ asset('/brands/election.png') }}" fill="none" viewBox="0 0 24 24"
                stroke-width="2" stroke="currentColor" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round"
                d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
        </x-nav-link>
        @else
        <x-nav-link href="/property/" :active="request()->routeIs('election')">
