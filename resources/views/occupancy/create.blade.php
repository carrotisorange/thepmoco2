<x-new-layout>
    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="pt-6 sm:pb-5">
                            ...
                            <div class="border border-gray-200 overflow-hidden lg:border-0">
                                ...
                                <a href="#" aria-current="step">
                                    ...
                                    <span class="px-6 py-5 flex items-start text-sm font-medium lg:pl-9">
                                        ...
                                        <span class="mt-0.5 ml-4 min-w-0 flex flex-col">
                                            <span class="text-sm font-medium text-gray-900">Document Information
                                            </span>
                            ...
                            <div class="border border-gray-200 overflow-hidden lg:border-0">
                                ...
                                <a href="#" aria-current="step">
                                    ...
                                    <span class="px-6 py-5 flex items-start text-sm font-medium lg:pl-9">
                                        ...
                                        <span class="mt-0.5 ml-4 min-w-0 flex flex-col">
                                            <span class="text-sm font-medium text-gray-900">Financial Information
                                            </span>
                            ...
                            <div class="border border-gray-200 overflow-hidden lg:border-0">
                                ...
                                <a href="#" aria-current="step">
                                    ...
                                    <span class="px-6 py-5 flex items-start text-sm font-medium lg:pl-9">
                                        ...
                                        <span class="mt-0.5 ml-4 min-w-0 flex flex-col">
                                            <span class="text-sm font-medium text-indigo-600">Occupancy Information
                                            </span>
            ...
            @livewire('occupancy-component', ['unit' => $unit, 'owner' => $owner])
        </div>
    </div>
</x-new-layout>