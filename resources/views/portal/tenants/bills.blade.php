        ...
        <div class="mt-10 px-4 sm:px-6 lg:px-8">
            <div class="sm:flex sm:items-center">
                ...
                <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                    ...
                    <button type="button" onclick="window.location.href='/{{auth()->user()->role_id}}/tenant/{{ auth()->user()->username }}/bills/export'" 
                        ...
                        <table class="min-w-full table-fixed">
                            ...
                            <tbody class=" divide-gray-50 border divide-y gap-y-6 bg-white">
                                ...
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap py-4 pr-3 text-sm font-medium"> <a href="tenantbills_detail" class="text-purple-900">{{ $item->bill_no}}</a>
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                        ...
                                        <span title="partially_paid" class="px-2 text-sm leading-5 font-semibold rounded-full bg-orange-100 text-orange-800">
                            ...
                            @empty
                            <tr>
                                <td class="whitespace-nowrap py-4 pr-4 text-right text-sm font-medium sm:pr-6">No bills found.</td>
                            </tr>
                            @endforelse
                        </table>
