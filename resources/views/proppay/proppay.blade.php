    ...
    <body>
        <nav id="nav" class="lg:sticky top-0 z-10 relative px-4 py-4 flex justify-between items-center">
            <a class="text-3xl font-bold leading-none" href="/">
                <img class="h-12" src="{{ asset('/brands/propsuite/propsuite-gray.png') }}"
            ...
            <a class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 proppayOrangebg hover:bg-gray-100 text-sm font-bold text-white hover:bg-gray-300  rounded-2xl transition duration-200"
    ...
    <main>
        ...
        <div id="proppay-bg" class="sm:block lg:flex md:flex min-h-screen py-16">
            ...
            <div class="flex-col justify-center sm:-py-2 md:py-20 lg:py-8 lg:px-48 sm-px-0">
                <div class="lg:block lg:py-20 md:max-w-lg xl:max-w-md sm:ml-12 sm:py-2 mx-5">
                    <p class="text-lg font-light mt-10 text-white">Online rent collection facility for landlords and
                        property
                        managers to bill and collect rent and other bills from their tenants.</p>

                    <div class="mt-10 flex justify-center items-center space-x-5">
                        <button class="proppayOrangebg rounded-full"> <a href="/select-a-plan"
                        ...
                        <div class="swiper mySwiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <h1 class="p-5 text-white text-lg text-center font-semibold">Manage multiple
                                        properties in one
                                        seamless and unified system</h1>
                                    <img width="1920" height="1080"
                                        src="{{ asset('/brands/landing/portfolio_img.webp') }}"
                                        alt="portfolio page showing 4 buildings" />
                                </div>
                                <div class="swiper-slide">
                                    <h1 class="p-5 text-white text-lg text-center font-semibold">A property dashboard
                                        for property
                                ...
                                <div class="swiper-slide">
                                    <h1 class="p-5 text-white text-lg text-center font-semibold">Easily collaborate with
                                        a centralized
                ...
                <div class="gap-x-6 gap-y-12 sm:grid grid-cols-2 lg:mt-16 lg:grid-cols-3 lg:gap-x-16 lg:gap-y-16">
                        ...
                        <div class="flex justify-center items-center ">
                            <div class="max-w-xs">
                                <div class="text-xs mt-6">
                                    ...
                                    <p class="mt-2">Track all of your bills and payments with one convenient portal so
                                        that all of your
                                        invoices and payments are in one place. You&#39;ll also be able to generate
                    ...
                    <div>
                        <div class="flex items-center justify-center">
                            ...
                            <h3 class="ml-5 flex text-center text-lg font-medium text-gray-600">Property Expenses
                                Tracking</h3>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex justify-center items-center">
                            <div class="max-w-xs">
                                <div class="text-xs mt-6">
                                    <p class="mt-2">Without the decision support system, decision making would be
                                        difficult. The property
                                        management
                                        system helps you to make the right decision at right time with its system
                                        generated reports.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex justify-center items-center">
                            <div class="max-w-xs">
                                <div class="text-xs mt-6">
                                    <p class="mt-2">This dashboard shows all of your portfolio&#39;s current prices—and
                                        what they would be
                                        if they were sold
                    ...
                    <div>
                        ...
                        <div class="flex justify-center items-center">
                            <div class="max-w-xs">
                                <div class="text-xs mt-6">
                                    <p class="mt-2">This portal allows you to manage units within your portfolio—and
                                        even take advantage
                                        of special offers
        ...
        <div class="relative py-16 sm:py-24 lg:py-32" id="guide">
            <div class="relative">
                ...
                <div
                    class="mx-auto mt-12 grid max-w-md gap-8 px-4 sm:max-w-lg sm:px-6 lg:max-w-7xl lg:grid-cols-5 lg:px-8">
                            ...
                            <div class="flex-1">
                                ...
                                <a class="mt-2 block">
                                    ...
                                    <p class="mt-3 text-sm text-gray-500">To kickstart the procedure register your
                                        condominiums,
                                        apartments, business spaces, residential units,
                            ...
                            <div class="flex-1">
                                ...
                                <a class="mt-2 block">
                                    ...
                                    <p class="mt-3 text-sm text-gray-500">Insert the tenant’s details like contact
                                        ...
                                        and terms of the contract, and other
                        ...
                        <div class="flex flex-1 flex-col justify-between bg-white p-6">
                            <div class="flex-1">
                                ...
                                <a class="mt-2 block">
                                    ...
                                    <p class="mt-3 text-sm text-gray-500">Portal provides you with an interface where
                                        you can supervise
                                        and manage all concerns of tenants, job
    ...
    <footer class="bg-gray-50" aria-labelledby="footer-heading">
        ...
        <div class="content-center mx-auto max-w-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
                ...
                <div class="grid grid-cols-3 gap-8 xl:col-span-2">
                    ...
                    <div class="md:grid md:grid-cols-1 md:gap-8">
                        ...
                        <ul role="list" class="mt-4 space-y-4">
                            ...
                            <li>
                                <a href="owner-corner" class="text-base text-gray-500 hover:text-gray-900">Property
                                    Owner's Corner</a>
                            </li>
            ...
            <div class="mt-12 border-t border-gray-200 pt-8 flex items-center justify-center lg:mt-16">
                ...
                <p class="mt-8 text-base text-gray-400 md:order-1 md:mt-0">&copy; 2022 {{  env('APP_NAME') }} All rights reserved.
                </p>
            </div>
        </div>
    </footer>
