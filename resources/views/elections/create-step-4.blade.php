<x-new-layout>
    ...
    <div class="mt-8">
        <div class="max-full mx-auto sm:px-6">
                        ...
                        <li class="flex">
                            <div class="flex items-center">
                                ...
                                <a href="/property/{{ Session::get('property_uuid') }}/election/{{ $election->id }}/create/step-4"
                                    class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page">Ballot Form</a>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            @livewire('election-create-step4-component',['election' => $election])
        </div>
    </div>
</x-new-layout>
