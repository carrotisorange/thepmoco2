<x-new-layout>
    ...
    <div class="mt-8">
        <div class="max-full mx-auto sm:px-6">
                    ...
                    <ol role="list" class="mx-auto flex w-full max-w-screen-xl space-x-4 px-4 sm:px-6 lg:px-8">
                        ...
                        <li class="flex">
                            <div class="flex items-center">
                                ...
                                <a href="/property/{{ Session::get('property_uuid') }}/election/{{ $election->id }}/create/step-1"
                        ...
                        <li class="flex">
                            <div class="flex items-center">
                                ...
                                <a href="/property/{{ Session::get('property_uuid') }}/election/{{ $election->id }}/create/step-2"
                                    class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700"
                                    aria-current="page">Eligible Voters</a>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex items-center">
                                ...
                                <a href="/property/{{ Session::get('property_uuid') }}/election/{{ $election->id }}/create/step-3"
                                    class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700"
                                    aria-current="page">Candidates</a>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex items-center">
                                ...
                                <a href="/property/{{ Session::get('property_uuid') }}/election/{{ $election->id }}/create/step-4"
                                    class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700"
                                    aria-current="page">Ballot Form</a>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex items-center">
                                ...
                                <a href="/property/{{ Session::get('property_uuid') }}/election/{{ $election->id }}/create/step-5"
                                    class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page">Voters Turnout</a>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            @livewire('election-create-step5-component',['election' => $election])
        </div>
    </div>
</x-new-layout>
