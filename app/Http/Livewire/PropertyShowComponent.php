...
class PropertyShowComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.property-show-component',[
            ...
            'delinquent_tenants' => app('App\Http\Controllers\PropertyController')->get_tenant_delinquents(),
            'delinquent_guests' => app('App\Http\Controllers\PropertyController')->get_guest_delinquents(),
            'delinquent_owners' => app('App\Http\Controllers\PropertyController')->get_owner_delinquents(),
