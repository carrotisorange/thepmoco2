...
class FinancialController extends Controller
{
    ...
    public function exportFinancial($property, $type, $filter){
         $data = [
              'total_occupancy' =>
              app('App\Http\Controllers\Features\FinancialController')->get_total_occupancy($property),

              'total_occupancy_rent' =>
              app('App\Http\Controllers\Features\FinancialController')->get_total_occupancy_rent($property),

              'total_vacancy' =>
              app('App\Http\Controllers\Features\FinancialController')->get_total_vacancy($property),

              'total_vacancy_rent' =>
              app('App\Http\Controllers\Features\FinancialController')->get_total_vacancy_rent($property),

              'total_occupied' =>
              app('App\Http\Controllers\Features\FinancialController')->get_total_occupied($property),

              'total_occupied_rent' =>
              app('App\Http\Controllers\Features\FinancialController')->get_total_occupied_rent($property),

              'potential_gross_rent' =>
              app('App\Http\Controllers\Features\FinancialController')->get_total_occupancy($property) *
              app('App\Http\Controllers\Features\FinancialController')->get_total_occupancy_rent($property),

              'less_vacancy' =>   app('App\Http\Controllers\Features\FinancialController')->get_total_vacancy($property) *
              app('App\Http\Controllers\Features\FinancialController')->get_total_vacancy_rent($property),
              ...
              'collected_rent' =>
              app('App\Http\Controllers\Features\FinancialController')->get_total_collected_rent($property),

                'billed_rent' =>
                app('App\Http\Controllers\Features\FinancialController')->get_total_billed_rent($property),

                'actual_revenue_collected' =>
                app('App\Http\Controllers\Features\FinancialController')->get_actual_revenue_collected($property),
          ];
    ...
    public function exportCashflow($property, $type, $filter){
          ...
          {
            $collections =
            app('App\Http\Controllers\Features\FinancialController')->getCollections('DATE_FORMAT(created_at, "%b-%Y") as
            date');

            $accountpayables =
            app('App\Http\Controllers\Features\FinancialController')->getExpenses('DATE_FORMAT(created_at, "%b-%Y") as
            date');

            }elseif($filter == 'yearly'){
            $collections =
            app('App\Http\Controllers\Features\FinancialController')->getCollections('DATE_FORMAT(created_at, "%Y") as
            date');

            $accountpayables =
            app('App\Http\Controllers\Features\FinancialController')->getExpenses('DATE_FORMAT(created_at, "%Y") as date');
            }else
            {
            $collections =
            app('App\Http\Controllers\Features\FinancialController')->getCollections('DATE_FORMAT(created_at, "%d-%b-%Y")
            as date');

            $accountpayables =
            app('App\Http\Controllers\Features\FinancialController')->getExpenses('DATE_FORMAT(created_at, "%d-%b-%Y") as
            date');
          }
